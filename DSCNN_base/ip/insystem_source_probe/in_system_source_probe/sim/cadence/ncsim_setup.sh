...
TOP_LEVEL_NAME="in_system_source_probe.in_system_source_probe"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="/software/quartus/qts18.1pro/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
set ELAB_OPTIONS ""
append ELAB_OPTIONS [in_system_source_probe::get_elab_options $SIMULATOR_TOOL_BITNESS]
puts "ELAB_OPTIONS+=\"$ELAB_OPTIONS\""
set SIM_OPTIONS ""
append SIM_OPTIONS [in_system_source_probe::get_sim_options $SIMULATOR_TOOL_BITNESS]
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set libraries [dict merge $libraries [in_system_source_probe::get_design_libraries]]
...
source $QSYS_SIMDIR/common/ncsim_files.tcl
set design_files [dict merge $design_files [in_system_source_probe::get_common_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
...
set files [list]
source $QSYS_SIMDIR/common/ncsim_files.tcl
set files [concat $files [in_system_source_probe::get_design_files $USER_DEFINED_COMPILE_OPTIONS $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_VHDL_COMPILE_OPTIONS "$QSYS_SIMDIR"]]
