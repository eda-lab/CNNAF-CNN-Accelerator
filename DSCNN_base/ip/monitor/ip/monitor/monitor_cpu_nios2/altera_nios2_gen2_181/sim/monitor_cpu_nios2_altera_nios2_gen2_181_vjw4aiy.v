// monitor_cpu_nios2_altera_nios2_gen2_181_vjw4aiy.v
...
`timescale 1 ps / 1 ps
module monitor_cpu_nios2_altera_nios2_gen2_181_vjw4aiy (
	...
	monitor_cpu_nios2_altera_nios2_gen2_unit_181_sh4qswa cpu (
		.clk                                 (clk),                                 //   input,   width = 1,                       clk.clk
		.reset_n                             (reset_n),                             //   input,   width = 1,                     reset.reset_n
		.reset_req                           (reset_req),                           //   input,   width = 1,                          .reset_req
		.d_address                           (d_address),                           //  output,  width = 20,               data_master.address
		...
		.i_address                           (i_address),                           //  output,  width = 20,        instruction_master.address
