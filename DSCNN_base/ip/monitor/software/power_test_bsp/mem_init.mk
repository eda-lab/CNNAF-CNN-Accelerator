...
# Memory: cpu_onchip_memory
MEM_0 := monitor_cpu_onchip_memory_cpu_onchip_memory
$(MEM_0)_NAME := cpu_onchip_memory
...
$(MEM_0)_HIERARCHICAL_PATH := cpu_onchip_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: cpu_onchip_memory
cpu_onchip_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
