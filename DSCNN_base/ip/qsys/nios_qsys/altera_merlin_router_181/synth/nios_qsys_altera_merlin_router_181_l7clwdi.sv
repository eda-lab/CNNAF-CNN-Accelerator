...
module nios_qsys_altera_merlin_router_181_l7clwdi_default_decode
  #(
...
module nios_qsys_altera_merlin_router_181_l7clwdi
(
    // -------------------
    // Clock & Reset
    // -------------------
    ...
    nios_qsys_altera_merlin_router_181_l7clwdi_default_decode the_default_decode(
    ...
    // ( 0x1020 .. 0x1030 )
    if ( {address[RG:PAD3],{PAD3{1'b0}}} == 17'h1020  && read_transaction  ) begin
            src_channel = 14'b01000000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 3;
    end

    // ( 0x1030 .. 0x1040 )
    if ( {address[RG:PAD4],{PAD4{1'b0}}} == 17'h1030  && read_transaction  ) begin
            src_channel = 14'b00100000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 4;
    end

    // ( 0x1040 .. 0x1050 )
    if ( {address[RG:PAD5],{PAD5{1'b0}}} == 17'h1040  && read_transaction  ) begin
            src_channel = 14'b00010000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 11;
    end

    // ( 0x1050 .. 0x1060 )
    if ( {address[RG:PAD6],{PAD6{1'b0}}} == 17'h1050  && read_transaction  ) begin
            src_channel = 14'b00001000000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 12;
    end

    // ( 0x1060 .. 0x1070 )
    if ( {address[RG:PAD7],{PAD7{1'b0}}} == 17'h1060  && read_transaction  ) begin
            src_channel = 14'b00000010000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 2;
    end

    // ( 0x1070 .. 0x1080 )
    if ( {address[RG:PAD8],{PAD8{1'b0}}} == 17'h1070   ) begin
            src_channel = 14'b00000001000000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 5;
    end

    // ( 0x1080 .. 0x1090 )
    if ( {address[RG:PAD9],{PAD9{1'b0}}} == 17'h1080   ) begin
            src_channel = 14'b00000000100000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 1;
    end

    // ( 0x1090 .. 0x10a0 )
    if ( {address[RG:PAD10],{PAD10{1'b0}}} == 17'h1090  && read_transaction  ) begin
            src_channel = 14'b00000000010000;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 0;
    end

    // ( 0x10b0 .. 0x10b8 )
    if ( {address[RG:PAD11],{PAD11{1'b0}}} == 17'h10b0  && read_transaction  ) begin
            src_channel = 14'b00000000000010;
            src_data[PKT_DEST_ID_H:PKT_DEST_ID_L] = 9;
    end

    // ( 0x10b8 .. 0x10c0 )
    if ( {address[RG:PAD12],{PAD12{1'b0}}} == 17'h10b8   ) begin
