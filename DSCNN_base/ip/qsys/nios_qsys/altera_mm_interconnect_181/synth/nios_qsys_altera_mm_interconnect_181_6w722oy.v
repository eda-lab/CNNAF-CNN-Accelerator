// nios_qsys_altera_mm_interconnect_181_6w722oy.v
...
`timescale 1 ps / 1 ps
module nios_qsys_altera_mm_interconnect_181_6w722oy (
	...
	wire    [8:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> calc_data_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> calc_finish_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> data_addr_s1_agent:cp_channel
	...
	wire    [8:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> calc_fps_s1_agent:cp_channel
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.rp_channel            (nios2_data_master_limiter_rsp_src_channel),                            //   input,    width = 9,          .channel
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.rp_channel            (nios2_instruction_master_limiter_rsp_src_channel),                            //   input,    width = 9,          .channel
	...
	nios_qsys_altera_merlin_router_181_xjcxclq router (
	...
	nios_qsys_altera_merlin_router_181_tsa7s7a router_001 (
	...
	nios_qsys_altera_merlin_router_181_7syr7sq router_002 (
	...
	nios_qsys_altera_merlin_router_181_7syr7sq router_003 (
	...
	nios_qsys_altera_merlin_router_181_7syr7sq router_004 (
	...
	nios_qsys_altera_merlin_router_181_7syr7sq router_005 (
	...
	nios_qsys_altera_merlin_router_181_pthi3rq router_006 (
	...
	nios_qsys_altera_merlin_router_181_pthi3rq router_007 (
	...
	nios_qsys_altera_merlin_router_181_pthi3rq router_008 (
	...
	nios_qsys_altera_merlin_router_181_pthi3rq router_009 (
	...
	nios_qsys_altera_merlin_router_181_pthi3rq router_010 (
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_src_channel        (nios2_data_master_limiter_cmd_src_channel),       //  output,    width = 9,          .channel
		...
		.rsp_src_channel        (nios2_data_master_limiter_rsp_src_channel),       //  output,    width = 9,          .channel
		...
		.cmd_src_valid          (nios2_data_master_limiter_cmd_valid_data)         //  output,    width = 9, cmd_valid.data
	);
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_sink_channel       (router_001_src_channel),                                 //   input,    width = 9,          .channel
		...
		.cmd_src_channel        (nios2_instruction_master_limiter_cmd_src_channel),       //  output,    width = 9,          .channel
		...
		.rsp_sink_channel       (rsp_mux_001_src_channel),                                //   input,    width = 9,          .channel
		...
		.rsp_src_channel        (nios2_instruction_master_limiter_rsp_src_channel),       //  output,    width = 9,          .channel
		...
		.cmd_src_valid          (nios2_instruction_master_limiter_cmd_valid_data)         //  output,    width = 9, cmd_valid.data
	);

	nios_qsys_altera_merlin_demultiplexer_181_kd6chwy cmd_demux (
		.clk                (clock_in_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),         //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_data_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_data_master_limiter_cmd_src_channel),       //   input,    width = 9,           .channel
		...
		.sink_valid         (nios2_data_master_limiter_cmd_valid_data),        //   input,    width = 9, sink_valid.data
	...
	nios_qsys_altera_merlin_demultiplexer_181_cdw54gq cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                                   //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_instruction_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_instruction_master_limiter_cmd_src_channel),       //   input,    width = 9,           .channel
		...
		.sink_valid         (nios2_instruction_master_limiter_cmd_valid_data),        //   input,    width = 9, sink_valid.data
		...
		.src2_channel       (cmd_demux_001_src2_channel),                             //  output,    width = 9,           .channel
		...
		.src3_channel       (cmd_demux_001_src3_channel),                             //  output,    width = 9,           .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_l7egkgi cmd_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_l7egkgi cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_l7egkgi cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_channel       (cmd_demux_001_src2_channel),              //   input,    width = 9,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_l7egkgi cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_channel       (cmd_demux_001_src3_channel),              //   input,    width = 9,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_jch6zyy cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_jch6zyy cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_jch6zyy cmd_mux_006 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_jch6zyy cmd_mux_007 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_jch6zyy cmd_mux_008 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_w2ym4wi rsp_demux (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src1_channel       (rsp_demux_src1_channel),                  //  output,    width = 9,          .channel
	...
	nios_qsys_altera_merlin_demultiplexer_181_w2ym4wi rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.src1_channel       (rsp_demux_001_src1_channel),              //  output,    width = 9,          .channel
	...
	nios_qsys_altera_merlin_demultiplexer_181_w2ym4wi rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_w2ym4wi rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_vxianli rsp_demux_004 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_vxianli rsp_demux_005 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_vxianli rsp_demux_006 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_vxianli rsp_demux_007 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_vxianli rsp_demux_008 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_5odlfki rsp_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_7ixev2a rsp_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (rsp_demux_src1_channel),                  //   input,    width = 9,          .channel
		...
		.sink1_channel       (rsp_demux_001_src1_channel),              //   input,    width = 9,          .channel
		...
		.sink2_channel       (rsp_demux_002_src1_channel),              //   input,    width = 9,          .channel
		...
		.sink3_channel       (rsp_demux_003_src1_channel),              //   input,    width = 9,          .channel
