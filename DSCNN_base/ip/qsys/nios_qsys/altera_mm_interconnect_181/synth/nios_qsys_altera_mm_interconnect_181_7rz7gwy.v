// nios_qsys_altera_mm_interconnect_181_7rz7gwy.v
...
`timescale 1 ps / 1 ps
module nios_qsys_altera_mm_interconnect_181_7rz7gwy (
	...
	wire  [102:0] calc_finish_s1_agent_rf_source_data;                                         // calc_finish_s1_agent:rf_source_data -> calc_finish_s1_agent_rsp_fifo:in_data
	...
	wire  [102:0] calc_finish_s1_agent_rsp_fifo_out_data;                                      // calc_finish_s1_agent_rsp_fifo:out_data -> calc_finish_s1_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> calc_finish_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                       // calc_finish_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> calc_finish_s1_agent:cp_channel
	...
	wire  [101:0] calc_finish_s1_agent_rp_data;                                                // calc_finish_s1_agent:rp_data -> router_007:sink_data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.rp_data                 (calc_finish_s1_agent_rp_data),                    //  output,  width = 102,                .data
		...
		.rf_sink_data            (calc_finish_s1_agent_rsp_fifo_out_data),          //   input,  width = 103,                .data
		...
		.rf_source_data          (calc_finish_s1_agent_rf_source_data),             //  output,  width = 103,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                            //   input,    width = 1,       clk.clk
		.reset             (jtag_reset_reset_bridge_in_reset_reset),          //   input,    width = 1, clk_reset.reset
		.in_data           (calc_finish_s1_agent_rf_source_data),             //   input,  width = 103,        in.data
		...
		.out_data          (calc_finish_s1_agent_rsp_fifo_out_data),          //  output,  width = 103,       out.data
	...
	nios_qsys_altera_merlin_router_181_xx32qpq router (
	...
	nios_qsys_altera_merlin_router_181_hliepqy router_007 (
		...
		.sink_data          (calc_finish_s1_agent_rp_data),           //   input,  width = 102,          .data
