// nios_qsys_altera_mm_interconnect_181_avhvkry.v
...
`timescale 1 ps / 1 ps
module nios_qsys_altera_mm_interconnect_181_avhvkry (
		...
		output wire [1:0]  data_req_s1_address,                     //                       data_req_s1.address
		output wire        data_req_s1_write,                       //                                  .write
		input  wire [31:0] data_req_s1_readdata,                    //                                  .readdata
		output wire [31:0] data_req_s1_writedata,                   //                                  .writedata
		output wire        data_req_s1_chipselect,                  //                                  .chipselect
	...
	wire  [102:0] cmd_mux_002_src_data;                                                        // cmd_mux_002:src_data -> nios2_debug_mem_slave_agent:cp_data
	...
	wire   [17:0] calc_data_s1_agent_m0_address;                                               // calc_data_s1_agent:m0_address -> calc_data_s1_translator:uav_address
	...
	wire  [103:0] calc_data_s1_agent_rf_source_data;                                           // calc_data_s1_agent:rf_source_data -> calc_data_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] calc_data_s1_agent_rsp_fifo_out_data;                                        // calc_data_s1_agent_rsp_fifo:out_data -> calc_data_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_004_src_data;                                                        // cmd_mux_004:src_data -> calc_data_s1_agent:cp_data
	wire          cmd_mux_004_src_ready;                                                       // calc_data_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire    [7:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> calc_data_s1_agent:cp_channel
	...
	wire   [31:0] data_req_s1_agent_m0_readdata;                                               // data_req_s1_translator:uav_readdata -> data_req_s1_agent:m0_readdata
	wire          data_req_s1_agent_m0_waitrequest;                                            // data_req_s1_translator:uav_waitrequest -> data_req_s1_agent:m0_waitrequest
	wire          data_req_s1_agent_m0_debugaccess;                                            // data_req_s1_agent:m0_debugaccess -> data_req_s1_translator:uav_debugaccess
	wire   [17:0] data_req_s1_agent_m0_address;                                                // data_req_s1_agent:m0_address -> data_req_s1_translator:uav_address
	wire    [3:0] data_req_s1_agent_m0_byteenable;                                             // data_req_s1_agent:m0_byteenable -> data_req_s1_translator:uav_byteenable
	wire          data_req_s1_agent_m0_read;                                                   // data_req_s1_agent:m0_read -> data_req_s1_translator:uav_read
	wire          data_req_s1_agent_m0_readdatavalid;                                          // data_req_s1_translator:uav_readdatavalid -> data_req_s1_agent:m0_readdatavalid
	wire          data_req_s1_agent_m0_lock;                                                   // data_req_s1_agent:m0_lock -> data_req_s1_translator:uav_lock
	wire   [31:0] data_req_s1_agent_m0_writedata;                                              // data_req_s1_agent:m0_writedata -> data_req_s1_translator:uav_writedata
	wire          data_req_s1_agent_m0_write;                                                  // data_req_s1_agent:m0_write -> data_req_s1_translator:uav_write
	wire    [2:0] data_req_s1_agent_m0_burstcount;                                             // data_req_s1_agent:m0_burstcount -> data_req_s1_translator:uav_burstcount
	wire          data_req_s1_agent_rf_source_valid;                                           // data_req_s1_agent:rf_source_valid -> data_req_s1_agent_rsp_fifo:in_valid
	wire  [103:0] data_req_s1_agent_rf_source_data;                                            // data_req_s1_agent:rf_source_data -> data_req_s1_agent_rsp_fifo:in_data
	wire          data_req_s1_agent_rf_source_ready;                                           // data_req_s1_agent_rsp_fifo:in_ready -> data_req_s1_agent:rf_source_ready
	wire          data_req_s1_agent_rf_source_startofpacket;                                   // data_req_s1_agent:rf_source_startofpacket -> data_req_s1_agent_rsp_fifo:in_startofpacket
	wire          data_req_s1_agent_rf_source_endofpacket;                                     // data_req_s1_agent:rf_source_endofpacket -> data_req_s1_agent_rsp_fifo:in_endofpacket
	wire          data_req_s1_agent_rsp_fifo_out_valid;                                        // data_req_s1_agent_rsp_fifo:out_valid -> data_req_s1_agent:rf_sink_valid
	wire  [103:0] data_req_s1_agent_rsp_fifo_out_data;                                         // data_req_s1_agent_rsp_fifo:out_data -> data_req_s1_agent:rf_sink_data
	wire          data_req_s1_agent_rsp_fifo_out_ready;                                        // data_req_s1_agent:rf_sink_ready -> data_req_s1_agent_rsp_fifo:out_ready
	wire          data_req_s1_agent_rsp_fifo_out_startofpacket;                                // data_req_s1_agent_rsp_fifo:out_startofpacket -> data_req_s1_agent:rf_sink_startofpacket
	wire          data_req_s1_agent_rsp_fifo_out_endofpacket;                                  // data_req_s1_agent_rsp_fifo:out_endofpacket -> data_req_s1_agent:rf_sink_endofpacket
	wire          data_req_s1_agent_rdata_fifo_src_valid;                                      // data_req_s1_agent:rdata_fifo_src_valid -> data_req_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] data_req_s1_agent_rdata_fifo_src_data;                                       // data_req_s1_agent:rdata_fifo_src_data -> data_req_s1_agent:rdata_fifo_sink_data
	wire          data_req_s1_agent_rdata_fifo_src_ready;                                      // data_req_s1_agent:rdata_fifo_sink_ready -> data_req_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_005_src_valid;                                                       // cmd_mux_005:src_valid -> data_req_s1_agent:cp_valid
	wire  [102:0] cmd_mux_005_src_data;                                                        // cmd_mux_005:src_data -> data_req_s1_agent:cp_data
	wire          cmd_mux_005_src_ready;                                                       // data_req_s1_agent:cp_ready -> cmd_mux_005:src_ready
	wire    [7:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> data_req_s1_agent:cp_channel
	wire          cmd_mux_005_src_startofpacket;                                               // cmd_mux_005:src_startofpacket -> data_req_s1_agent:cp_startofpacket
	wire          cmd_mux_005_src_endofpacket;                                                 // cmd_mux_005:src_endofpacket -> data_req_s1_agent:cp_endofpacket
	...
	wire   [17:0] data_addr_s1_agent_m0_address;                                               // data_addr_s1_agent:m0_address -> data_addr_s1_translator:uav_address
	...
	wire  [103:0] data_addr_s1_agent_rf_source_data;                                           // data_addr_s1_agent:rf_source_data -> data_addr_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] data_addr_s1_agent_rsp_fifo_out_data;                                        // data_addr_s1_agent_rsp_fifo:out_data -> data_addr_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_006_src_data;                                                        // cmd_mux_006:src_data -> data_addr_s1_agent:cp_data
	wire          cmd_mux_006_src_ready;                                                       // data_addr_s1_agent:cp_ready -> cmd_mux_006:src_ready
	wire    [7:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> data_addr_s1_agent:cp_channel
	...
	wire   [17:0] calc_fps_s1_agent_m0_address;                                                // calc_fps_s1_agent:m0_address -> calc_fps_s1_translator:uav_address
	...
	wire  [103:0] calc_fps_s1_agent_rf_source_data;                                            // calc_fps_s1_agent:rf_source_data -> calc_fps_s1_agent_rsp_fifo:in_data
	...
	wire  [103:0] calc_fps_s1_agent_rsp_fifo_out_data;                                         // calc_fps_s1_agent_rsp_fifo:out_data -> calc_fps_s1_agent:rf_sink_data
	...
	wire  [102:0] cmd_mux_007_src_data;                                                        // cmd_mux_007:src_data -> calc_fps_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                       // calc_fps_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [7:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> calc_fps_s1_agent:cp_channel
	...
	wire  [102:0] nios2_debug_mem_slave_agent_rp_data;                                         // nios2_debug_mem_slave_agent:rp_data -> router_004:sink_data
	...
	wire  [102:0] calc_data_s1_agent_rp_data;                                                  // calc_data_s1_agent:rp_data -> router_006:sink_data
	...
	wire          data_req_s1_agent_rp_valid;                                                  // data_req_s1_agent:rp_valid -> router_007:sink_valid
	wire  [102:0] data_req_s1_agent_rp_data;                                                   // data_req_s1_agent:rp_data -> router_007:sink_data
	wire          data_req_s1_agent_rp_ready;                                                  // router_007:sink_ready -> data_req_s1_agent:rp_ready
	wire          data_req_s1_agent_rp_startofpacket;                                          // data_req_s1_agent:rp_startofpacket -> router_007:sink_startofpacket
	wire          data_req_s1_agent_rp_endofpacket;                                            // data_req_s1_agent:rp_endofpacket -> router_007:sink_endofpacket
	...
	wire  [102:0] data_addr_s1_agent_rp_data;                                                  // data_addr_s1_agent:rp_data -> router_008:sink_data
	...
	wire  [102:0] calc_fps_s1_agent_rp_data;                                                   // calc_fps_s1_agent:rp_data -> router_009:sink_data
	...
	wire  [102:0] router_src_data;                                                             // router:src_data -> nios2_data_master_limiter:cmd_sink_data
	...
	wire  [102:0] nios2_data_master_limiter_cmd_src_data;                                      // nios2_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [102:0] rsp_mux_src_data;                                                            // rsp_mux:src_data -> nios2_data_master_limiter:rsp_sink_data
	...
	wire  [102:0] nios2_data_master_limiter_rsp_src_data;                                      // nios2_data_master_limiter:rsp_src_data -> nios2_data_master_agent:rp_data
	...
	wire  [102:0] router_001_src_data;                                                         // router_001:src_data -> nios2_instruction_master_limiter:cmd_sink_data
	...
	wire  [102:0] nios2_instruction_master_limiter_cmd_src_data;                               // nios2_instruction_master_limiter:cmd_src_data -> cmd_demux_001:sink_data
	...
	wire  [102:0] rsp_mux_001_src_data;                                                        // rsp_mux_001:src_data -> nios2_instruction_master_limiter:rsp_sink_data
	...
	wire  [102:0] nios2_instruction_master_limiter_rsp_src_data;                               // nios2_instruction_master_limiter:rsp_src_data -> nios2_instruction_master_agent:rp_data
	...
	nios_qsys_altera_merlin_master_translator_181_mhudjri #(
		...
		.uav_address            (nios2_data_master_translator_avalon_universal_master_0_address),       //  output,  width = 18, avalon_universal_master_0.address
		...
		.av_address             (nios2_data_master_address),                                            //   input,  width = 18,      avalon_anti_master_0.address
	...
	nios_qsys_altera_merlin_master_translator_181_mhudjri #(
		...
		.clk                    (clock_in_out_clk_clk),                                                        //   input,   width = 1,                       clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),                                     //   input,   width = 1,                     reset.reset
		.uav_address            (nios2_instruction_master_translator_avalon_universal_master_0_address),       //  output,  width = 18, avalon_universal_master_0.address
		...
		.av_address             (nios2_instruction_master_address),                                            //   input,  width = 18,      avalon_anti_master_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                          //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),       //   input,   width = 1,                    reset.reset
		.uav_address            (jtag_avalon_jtag_slave_agent_m0_address),       //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                       //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),    //   input,   width = 1,                    reset.reset
		.uav_address            (sysid_control_slave_agent_m0_address),       //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                         //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),      //   input,   width = 1,                    reset.reset
		.uav_address            (nios2_debug_mem_slave_agent_m0_address),       //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                    //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (onchip_ram_s1_agent_m0_address),          //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                    //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (calc_data_s1_agent_m0_address),           //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) data_req_s1_translator (
		.clk                    (clock_in_out_clk_clk),                    //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (data_req_s1_agent_m0_address),            //   input,  width = 18, avalon_universal_slave_0.address
		.uav_burstcount         (data_req_s1_agent_m0_burstcount),         //   input,   width = 3,                         .burstcount
		.uav_read               (data_req_s1_agent_m0_read),               //   input,   width = 1,                         .read
		.uav_write              (data_req_s1_agent_m0_write),              //   input,   width = 1,                         .write
		.uav_waitrequest        (data_req_s1_agent_m0_waitrequest),        //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (data_req_s1_agent_m0_readdatavalid),      //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (data_req_s1_agent_m0_byteenable),         //   input,   width = 4,                         .byteenable
		.uav_readdata           (data_req_s1_agent_m0_readdata),           //  output,  width = 32,                         .readdata
		.uav_writedata          (data_req_s1_agent_m0_writedata),          //   input,  width = 32,                         .writedata
		.uav_lock               (data_req_s1_agent_m0_lock),               //   input,   width = 1,                         .lock
		.uav_debugaccess        (data_req_s1_agent_m0_debugaccess),        //   input,   width = 1,                         .debugaccess
		.av_address             (data_req_s1_address),                     //  output,   width = 2,      avalon_anti_slave_0.address
		.av_write               (data_req_s1_write),                       //  output,   width = 1,                         .write
		.av_readdata            (data_req_s1_readdata),                    //   input,  width = 32,                         .readdata
		.av_writedata           (data_req_s1_writedata),                   //  output,  width = 32,                         .writedata
		.av_chipselect          (data_req_s1_chipselect),                  //  output,   width = 1,                         .chipselect
		.av_read                (),                                        // (terminated),                                       
		.av_begintransfer       (),                                        // (terminated),                                       
		.av_beginbursttransfer  (),                                        // (terminated),                                       
		.av_burstcount          (),                                        // (terminated),                                       
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                    //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (data_addr_s1_agent_m0_address),           //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                    //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (calc_fps_s1_agent_m0_address),            //   input,  width = 18, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.av_address            (nios2_data_master_translator_avalon_universal_master_0_address),       //   input,   width = 18,        av.address
		...
		.cp_data               (nios2_data_master_agent_cp_data),                                      //  output,  width = 103,          .data
		...
		.rp_data               (nios2_data_master_limiter_rsp_src_data),                               //   input,  width = 103,          .data
		.rp_channel            (nios2_data_master_limiter_rsp_src_channel),                            //   input,    width = 8,          .channel
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.clk                   (clock_in_out_clk_clk),                                                        //   input,    width = 1,       clk.clk
		.reset                 (nios2_reset_reset_bridge_in_reset_reset),                                     //   input,    width = 1, clk_reset.reset
		.av_address            (nios2_instruction_master_translator_avalon_universal_master_0_address),       //   input,   width = 18,        av.address
		...
		.cp_data               (nios2_instruction_master_agent_cp_data),                                      //  output,  width = 103,          .data
		...
		.rp_data               (nios2_instruction_master_limiter_rsp_src_data),                               //   input,  width = 103,          .data
		.rp_channel            (nios2_instruction_master_limiter_rsp_src_channel),                            //   input,    width = 8,          .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                                    //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),                 //   input,    width = 1,       clk_reset.reset
		.m0_address              (jtag_avalon_jtag_slave_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (jtag_avalon_jtag_slave_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_src_data),                                        //   input,  width = 103,                .data
		...
		.rf_sink_data            (jtag_avalon_jtag_slave_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (jtag_avalon_jtag_slave_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                                    //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),                 //   input,    width = 1, clk_reset.reset
		.in_data           (jtag_avalon_jtag_slave_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (jtag_avalon_jtag_slave_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                                 //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),              //   input,    width = 1,       clk_reset.reset
		.m0_address              (sysid_control_slave_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (sysid_control_slave_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_001_src_data),                                 //   input,  width = 103,                .data
		...
		.rf_sink_data            (sysid_control_slave_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (sysid_control_slave_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                                 //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),              //   input,    width = 1, clk_reset.reset
		.in_data           (sysid_control_slave_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (sysid_control_slave_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                                   //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),                //   input,    width = 1,       clk_reset.reset
		.m0_address              (nios2_debug_mem_slave_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (nios2_debug_mem_slave_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_002_src_data),                                   //   input,  width = 103,                .data
		...
		.rf_sink_data            (nios2_debug_mem_slave_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (nios2_debug_mem_slave_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                                   //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),                //   input,    width = 1, clk_reset.reset
		.in_data           (nios2_debug_mem_slave_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (nios2_debug_mem_slave_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                           //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),        //   input,    width = 1,       clk_reset.reset
		.m0_address              (onchip_ram_s1_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (onchip_ram_s1_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_003_src_data),                           //   input,  width = 103,                .data
		...
		.rf_sink_data            (onchip_ram_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (onchip_ram_s1_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                           //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),        //   input,    width = 1, clk_reset.reset
		.in_data           (onchip_ram_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (onchip_ram_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                          //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),       //   input,    width = 1,       clk_reset.reset
		.m0_address              (calc_data_s1_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (calc_data_s1_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_004_src_data),                          //   input,  width = 103,                .data
		...
		.rf_sink_data            (calc_data_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (calc_data_s1_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		.in_data           (calc_data_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (calc_data_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                         //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),      //   input,    width = 1,       clk_reset.reset
		.m0_address              (data_req_s1_agent_m0_address),                 //  output,   width = 18,              m0.address
		.m0_burstcount           (data_req_s1_agent_m0_burstcount),              //  output,    width = 3,                .burstcount
		.m0_byteenable           (data_req_s1_agent_m0_byteenable),              //  output,    width = 4,                .byteenable
		.m0_debugaccess          (data_req_s1_agent_m0_debugaccess),             //  output,    width = 1,                .debugaccess
		.m0_lock                 (data_req_s1_agent_m0_lock),                    //  output,    width = 1,                .lock
		.m0_readdata             (data_req_s1_agent_m0_readdata),                //   input,   width = 32,                .readdata
		.m0_readdatavalid        (data_req_s1_agent_m0_readdatavalid),           //   input,    width = 1,                .readdatavalid
		.m0_read                 (data_req_s1_agent_m0_read),                    //  output,    width = 1,                .read
		.m0_waitrequest          (data_req_s1_agent_m0_waitrequest),             //   input,    width = 1,                .waitrequest
		.m0_writedata            (data_req_s1_agent_m0_writedata),               //  output,   width = 32,                .writedata
		.m0_write                (data_req_s1_agent_m0_write),                   //  output,    width = 1,                .write
		.rp_endofpacket          (data_req_s1_agent_rp_endofpacket),             //  output,    width = 1,              rp.endofpacket
		.rp_ready                (data_req_s1_agent_rp_ready),                   //   input,    width = 1,                .ready
		.rp_valid                (data_req_s1_agent_rp_valid),                   //  output,    width = 1,                .valid
		.rp_data                 (data_req_s1_agent_rp_data),                    //  output,  width = 103,                .data
		.rp_startofpacket        (data_req_s1_agent_rp_startofpacket),           //  output,    width = 1,                .startofpacket
		.cp_ready                (cmd_mux_005_src_ready),                        //  output,    width = 1,              cp.ready
		.cp_valid                (cmd_mux_005_src_valid),                        //   input,    width = 1,                .valid
		.cp_data                 (cmd_mux_005_src_data),                         //   input,  width = 103,                .data
		...
		.rf_sink_ready           (data_req_s1_agent_rsp_fifo_out_ready),         //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (data_req_s1_agent_rsp_fifo_out_valid),         //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (data_req_s1_agent_rsp_fifo_out_startofpacket), //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (data_req_s1_agent_rsp_fifo_out_endofpacket),   //   input,    width = 1,                .endofpacket
		.rf_sink_data            (data_req_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		.rf_source_ready         (data_req_s1_agent_rf_source_ready),            //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (data_req_s1_agent_rf_source_valid),            //  output,    width = 1,                .valid
		.rf_source_startofpacket (data_req_s1_agent_rf_source_startofpacket),    //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (data_req_s1_agent_rf_source_endofpacket),      //  output,    width = 1,                .endofpacket
		.rf_source_data          (data_req_s1_agent_rf_source_data),             //  output,  width = 104,                .data
		.rdata_fifo_sink_ready   (data_req_s1_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (data_req_s1_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (data_req_s1_agent_rdata_fifo_src_data),        //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (data_req_s1_agent_rdata_fifo_src_ready),       //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (data_req_s1_agent_rdata_fifo_src_valid),       //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (data_req_s1_agent_rdata_fifo_src_data),        //  output,   width = 34,                .data
		.m0_response             (2'b00),                                        // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                         // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                          // (terminated),                               
	);
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) data_req_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		.in_data           (data_req_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		.in_valid          (data_req_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (data_req_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (data_req_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (data_req_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (data_req_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
		.out_valid         (data_req_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (data_req_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (data_req_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (data_req_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                        // (terminated),                         
		.csr_read          (1'b0),                                         // (terminated),                         
		.csr_write         (1'b0),                                         // (terminated),                         
		.csr_readdata      (),                                             // (terminated),                         
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                          //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),       //   input,    width = 1,       clk_reset.reset
		.m0_address              (data_addr_s1_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (data_addr_s1_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_006_src_data),                          //   input,  width = 103,                .data
		...
		.rf_sink_data            (data_addr_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (data_addr_s1_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		.in_data           (data_addr_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (data_addr_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                         //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),      //   input,    width = 1,       clk_reset.reset
		.m0_address              (calc_fps_s1_agent_m0_address),                 //  output,   width = 18,              m0.address
		...
		.rp_data                 (calc_fps_s1_agent_rp_data),                    //  output,  width = 103,                .data
		...
		.cp_data                 (cmd_mux_007_src_data),                         //   input,  width = 103,                .data
		...
		.rf_sink_data            (calc_fps_s1_agent_rsp_fifo_out_data),          //   input,  width = 104,                .data
		...
		.rf_source_data          (calc_fps_s1_agent_rf_source_data),             //  output,  width = 104,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                         //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),      //   input,    width = 1, clk_reset.reset
		.in_data           (calc_fps_s1_agent_rf_source_data),             //   input,  width = 104,        in.data
		...
		.out_data          (calc_fps_s1_agent_rsp_fifo_out_data),          //  output,  width = 104,       out.data
	...
	nios_qsys_altera_merlin_router_181_2a4v77a router (
		...
		.sink_data          (nios2_data_master_agent_cp_data),          //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_fyue6mq router_001 (
		...
		.sink_data          (nios2_instruction_master_agent_cp_data),          //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_dcpmiia router_002 (
		...
		.sink_data          (jtag_avalon_jtag_slave_agent_rp_data),          //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_dcpmiia router_003 (
		...
		.sink_data          (sysid_control_slave_agent_rp_data),          //   input,  width = 103,          .data
		...
		.src_data           (router_003_src_data),                        //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_k332hdy router_004 (
		...
		.sink_data          (nios2_debug_mem_slave_agent_rp_data),          //   input,  width = 103,          .data
		...
		.src_data           (router_004_src_data),                          //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_k332hdy router_005 (
		...
		.sink_data          (onchip_ram_s1_agent_rp_data),             //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_dcpmiia router_006 (
		...
		.sink_data          (calc_data_s1_agent_rp_data),              //   input,  width = 103,          .data
		...
		.src_data           (router_006_src_data),                     //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_dcpmiia router_007 (
		.sink_ready         (data_req_s1_agent_rp_ready),              //  output,    width = 1,      sink.ready
		.sink_valid         (data_req_s1_agent_rp_valid),              //   input,    width = 1,          .valid
		.sink_data          (data_req_s1_agent_rp_data),               //   input,  width = 103,          .data
		.sink_startofpacket (data_req_s1_agent_rp_startofpacket),      //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (data_req_s1_agent_rp_endofpacket),        //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready          (router_007_src_ready),                    //   input,    width = 1,       src.ready
		.src_valid          (router_007_src_valid),                    //  output,    width = 1,          .valid
		.src_data           (router_007_src_data),                     //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_router_181_dcpmiia router_008 (
		...
		.sink_data          (data_addr_s1_agent_rp_data),              //   input,  width = 103,          .data
		...
		.src_data           (router_008_src_data),                     //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_src_data           (nios2_data_master_limiter_cmd_src_data),          //  output,  width = 103,          .data
		.cmd_src_channel        (nios2_data_master_limiter_cmd_src_channel),       //  output,    width = 8,          .channel
		...
		.rsp_src_data           (nios2_data_master_limiter_rsp_src_data),          //  output,  width = 103,          .data
		.rsp_src_channel        (nios2_data_master_limiter_rsp_src_channel),       //  output,    width = 8,          .channel
		...
		.cmd_src_valid          (nios2_data_master_limiter_cmd_valid_data)         //  output,    width = 8, cmd_valid.data
	);
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_sink_data          (router_001_src_data),                                    //   input,  width = 103,          .data
		...
		.cmd_src_data           (nios2_instruction_master_limiter_cmd_src_data),          //  output,  width = 103,          .data
		.cmd_src_channel        (nios2_instruction_master_limiter_cmd_src_channel),       //  output,    width = 8,          .channel
		...
		.rsp_sink_data          (rsp_mux_001_src_data),                                   //   input,  width = 103,          .data
		...
		.rsp_src_data           (nios2_instruction_master_limiter_rsp_src_data),          //  output,  width = 103,          .data
		.rsp_src_channel        (nios2_instruction_master_limiter_rsp_src_channel),       //  output,    width = 8,          .channel
		...
		.cmd_src_valid          (nios2_instruction_master_limiter_cmd_valid_data)         //  output,    width = 8, cmd_valid.data
	);

	nios_qsys_altera_merlin_demultiplexer_181_ho5ap6y cmd_demux (
		.clk                (clock_in_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),         //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_data_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_data_master_limiter_cmd_src_channel),       //   input,    width = 8,           .channel
		.sink_data          (nios2_data_master_limiter_cmd_src_data),          //   input,  width = 103,           .data
		...
		.sink_valid         (nios2_data_master_limiter_cmd_valid_data),        //   input,    width = 8, sink_valid.data
		...
		.src2_data          (cmd_demux_src2_data),                             //  output,  width = 103,           .data
		...
		.src3_data          (cmd_demux_src3_data),                             //  output,  width = 103,           .data
		...
		.src4_data          (cmd_demux_src4_data),                             //  output,  width = 103,           .data
		...
		.src5_data          (cmd_demux_src5_data),                             //  output,  width = 103,           .data
		...
		.src6_data          (cmd_demux_src6_data),                             //  output,  width = 103,           .data
		...
		.src7_data          (cmd_demux_src7_data),                             //  output,  width = 103,           .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_76lh5fa cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                                   //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_instruction_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_instruction_master_limiter_cmd_src_channel),       //   input,    width = 8,           .channel
		.sink_data          (nios2_instruction_master_limiter_cmd_src_data),          //   input,  width = 103,           .data
		...
		.sink_valid         (nios2_instruction_master_limiter_cmd_valid_data),        //   input,    width = 8, sink_valid.data
		.src0_ready         (cmd_demux_001_src0_ready),                               //   input,    width = 1,       src0.ready
		.src0_valid         (cmd_demux_001_src0_valid),                               //  output,    width = 1,           .valid
		.src0_data          (cmd_demux_001_src0_data),                                //  output,  width = 103,           .data
		...
		.src1_data          (cmd_demux_001_src1_data),                                //  output,  width = 103,           .data
	...
	nios_qsys_altera_merlin_multiplexer_181_s6z4jqi cmd_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_s6z4jqi cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_2ttdcsa cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_002_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_002_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_002_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_data          (cmd_demux_src2_data),                     //   input,  width = 103,          .data
		...
		.sink1_channel       (cmd_demux_001_src0_channel),              //   input,    width = 8,          .channel
		.sink1_data          (cmd_demux_001_src0_data),                 //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_2ttdcsa cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_003_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_003_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_003_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_data          (cmd_demux_src3_data),                     //   input,  width = 103,          .data
		...
		.sink1_channel       (cmd_demux_001_src1_channel),              //   input,    width = 8,          .channel
		.sink1_data          (cmd_demux_001_src1_data),                 //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_s6z4jqi cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_004_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_004_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_004_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_data          (cmd_demux_src4_data),                     //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_s6z4jqi cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_005_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_005_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_005_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_data          (cmd_demux_src5_data),                     //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_s6z4jqi cmd_mux_006 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_006_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_006_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_006_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_data          (cmd_demux_src6_data),                     //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_s6z4jqi cmd_mux_007 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_007_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_007_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_007_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_data          (cmd_demux_src7_data),                     //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_jg43owy rsp_demux (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_7fzpheq rsp_demux_002 (
		...
		.src0_data          (rsp_demux_002_src0_data),                 //  output,  width = 103,          .data
		...
		.src1_data          (rsp_demux_002_src1_data),                 //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_7fzpheq rsp_demux_003 (
		...
		.src0_data          (rsp_demux_003_src0_data),                 //  output,  width = 103,          .data
		...
		.src1_data          (rsp_demux_003_src1_data),                 //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_jg43owy rsp_demux_004 (
		...
		.src0_data          (rsp_demux_004_src0_data),                 //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_jg43owy rsp_demux_005 (
		...
		.src0_data          (rsp_demux_005_src0_data),                 //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_jg43owy rsp_demux_006 (
		...
		.src0_data          (rsp_demux_006_src0_data),                 //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_jg43owy rsp_demux_007 (
		...
		.src0_data          (rsp_demux_007_src0_data),                 //  output,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_b6proaa rsp_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink2_data          (rsp_demux_002_src0_data),                 //   input,  width = 103,          .data
		...
		.sink3_data          (rsp_demux_003_src0_data),                 //   input,  width = 103,          .data
		...
		.sink4_data          (rsp_demux_004_src0_data),                 //   input,  width = 103,          .data
		...
		.sink5_data          (rsp_demux_005_src0_data),                 //   input,  width = 103,          .data
		...
		.sink6_data          (rsp_demux_006_src0_data),                 //   input,  width = 103,          .data
		...
		.sink7_data          (rsp_demux_007_src0_data),                 //   input,  width = 103,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_n6xhfwq rsp_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (rsp_mux_001_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (rsp_mux_001_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (rsp_mux_001_src_data),                    //  output,  width = 103,          .data
		...
		.sink0_channel       (rsp_demux_002_src1_channel),              //   input,    width = 8,          .channel
		.sink0_data          (rsp_demux_002_src1_data),                 //   input,  width = 103,          .data
		...
		.sink1_channel       (rsp_demux_003_src1_channel),              //   input,    width = 8,          .channel
		.sink1_data          (rsp_demux_003_src1_data),                 //   input,  width = 103,          .data
