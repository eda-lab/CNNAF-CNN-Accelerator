// nios_qsys_altera_mm_interconnect_181_b3xbm3y.v
...
`timescale 1 ps / 1 ps
module nios_qsys_altera_mm_interconnect_181_b3xbm3y (
	...
	wire    [6:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> calc_data_s1_agent:cp_channel
	...
	wire    [6:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> data_req_s1_agent:cp_channel
	...
	wire    [6:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> data_addr_s1_agent:cp_channel
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.rp_channel            (nios2_data_master_limiter_rsp_src_channel),                            //   input,    width = 7,          .channel
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.rp_channel            (nios2_instruction_master_limiter_rsp_src_channel),                            //   input,    width = 7,          .channel
	...
	nios_qsys_altera_merlin_router_181_l7g4hxa router (
	...
	nios_qsys_altera_merlin_router_181_ozs4iwi router_001 (
	...
	nios_qsys_altera_merlin_router_181_mdafs6y router_002 (
	...
	nios_qsys_altera_merlin_router_181_mdafs6y router_003 (
	...
	nios_qsys_altera_merlin_router_181_24ufcby router_004 (
	...
	nios_qsys_altera_merlin_router_181_24ufcby router_005 (
	...
	nios_qsys_altera_merlin_router_181_mdafs6y router_006 (
	...
	nios_qsys_altera_merlin_router_181_mdafs6y router_007 (
	...
	nios_qsys_altera_merlin_router_181_mdafs6y router_008 (
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_src_channel        (nios2_data_master_limiter_cmd_src_channel),       //  output,    width = 7,          .channel
		...
		.rsp_src_channel        (nios2_data_master_limiter_rsp_src_channel),       //  output,    width = 7,          .channel
		...
		.cmd_src_valid          (nios2_data_master_limiter_cmd_valid_data)         //  output,    width = 7, cmd_valid.data
	);
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_src_channel        (nios2_instruction_master_limiter_cmd_src_channel),       //  output,    width = 7,          .channel
		...
		.rsp_src_channel        (nios2_instruction_master_limiter_rsp_src_channel),       //  output,    width = 7,          .channel
		...
		.cmd_src_valid          (nios2_instruction_master_limiter_cmd_valid_data)         //  output,    width = 7, cmd_valid.data
	);

	nios_qsys_altera_merlin_demultiplexer_181_z3mhgqi cmd_demux (
		.clk                (clock_in_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),         //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_data_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_data_master_limiter_cmd_src_channel),       //   input,    width = 7,           .channel
		...
		.sink_valid         (nios2_data_master_limiter_cmd_valid_data),        //   input,    width = 7, sink_valid.data
	...
	nios_qsys_altera_merlin_demultiplexer_181_gk3ktji cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                                   //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_instruction_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_instruction_master_limiter_cmd_src_channel),       //   input,    width = 7,           .channel
		...
		.sink_valid         (nios2_instruction_master_limiter_cmd_valid_data),        //   input,    width = 7, sink_valid.data
	...
	nios_qsys_altera_merlin_multiplexer_181_abrhreq cmd_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_abrhreq cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_pn6xe3q cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_pn6xe3q cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_channel       (cmd_demux_001_src1_channel),              //   input,    width = 7,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_abrhreq cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_abrhreq cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_abrhreq cmd_mux_006 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_i34tf4a rsp_demux (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_i34tf4a rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_sq5imfq rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_sq5imfq rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_i34tf4a rsp_demux_004 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_i34tf4a rsp_demux_005 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_i34tf4a rsp_demux_006 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_aoqiwra rsp_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_multiplexer_181_osjmtiq rsp_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink1_channel       (rsp_demux_003_src1_channel),              //   input,    width = 7,          .channel
