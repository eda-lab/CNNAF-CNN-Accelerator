// nios_qsys_altera_mm_interconnect_181_bifpa6i.v
...
`timescale 1 ps / 1 ps
module nios_qsys_altera_mm_interconnect_181_bifpa6i (
		...
		output wire [1:0]  calc_unit_used_s1_address,                        //                          calc_unit_used_s1.address
		input  wire [31:0] calc_unit_used_s1_readdata,                       //                                           .readdata
		output wire [1:0]  calc_unit_total_s1_address,                       //                         calc_unit_total_s1.address
		input  wire [31:0] calc_unit_total_s1_readdata,                      //                                           .readdata
		output wire [1:0]  wr_ddrvld_s1_address,                             //                               wr_ddrvld_s1.address
		input  wire [31:0] wr_ddrvld_s1_readdata,                            //                                           .readdata
		...
		input  wire        power_temp_scl_reset_reset_bridge_in_reset_reset, // power_temp_scl_reset_reset_bridge_in_reset.reset
	...
	wire   [15:0] cmd_mux_001_src_channel;                                                     // cmd_mux_001:src_channel -> sysid_control_slave_agent:cp_channel
	...
	wire   [15:0] cmd_mux_003_src_channel;                                                     // cmd_mux_003:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_004_src_channel;                                                     // cmd_mux_004:src_channel -> calc_data_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_005_src_channel;                                                     // cmd_mux_005:src_channel -> calc_finish_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_006_src_channel;                                                     // cmd_mux_006:src_channel -> data_addr_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_007_src_channel;                                                     // cmd_mux_007:src_channel -> calc_fps_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_009_src_channel;                                                     // cmd_mux_009:src_channel -> used_ddrvld_s1_agent:cp_channel
	...
	wire   [15:0] cmd_mux_010_src_channel;                                                     // cmd_mux_010:src_channel -> unused_ddrvld_s1_agent:cp_channel
	...
	wire   [31:0] calc_unit_used_s1_agent_m0_readdata;                                         // calc_unit_used_s1_translator:uav_readdata -> calc_unit_used_s1_agent:m0_readdata
	wire          calc_unit_used_s1_agent_m0_waitrequest;                                      // calc_unit_used_s1_translator:uav_waitrequest -> calc_unit_used_s1_agent:m0_waitrequest
	wire          calc_unit_used_s1_agent_m0_debugaccess;                                      // calc_unit_used_s1_agent:m0_debugaccess -> calc_unit_used_s1_translator:uav_debugaccess
	wire   [16:0] calc_unit_used_s1_agent_m0_address;                                          // calc_unit_used_s1_agent:m0_address -> calc_unit_used_s1_translator:uav_address
	wire    [3:0] calc_unit_used_s1_agent_m0_byteenable;                                       // calc_unit_used_s1_agent:m0_byteenable -> calc_unit_used_s1_translator:uav_byteenable
	wire          calc_unit_used_s1_agent_m0_read;                                             // calc_unit_used_s1_agent:m0_read -> calc_unit_used_s1_translator:uav_read
	wire          calc_unit_used_s1_agent_m0_readdatavalid;                                    // calc_unit_used_s1_translator:uav_readdatavalid -> calc_unit_used_s1_agent:m0_readdatavalid
	wire          calc_unit_used_s1_agent_m0_lock;                                             // calc_unit_used_s1_agent:m0_lock -> calc_unit_used_s1_translator:uav_lock
	wire   [31:0] calc_unit_used_s1_agent_m0_writedata;                                        // calc_unit_used_s1_agent:m0_writedata -> calc_unit_used_s1_translator:uav_writedata
	wire          calc_unit_used_s1_agent_m0_write;                                            // calc_unit_used_s1_agent:m0_write -> calc_unit_used_s1_translator:uav_write
	wire    [2:0] calc_unit_used_s1_agent_m0_burstcount;                                       // calc_unit_used_s1_agent:m0_burstcount -> calc_unit_used_s1_translator:uav_burstcount
	wire          calc_unit_used_s1_agent_rf_source_valid;                                     // calc_unit_used_s1_agent:rf_source_valid -> calc_unit_used_s1_agent_rsp_fifo:in_valid
	wire  [104:0] calc_unit_used_s1_agent_rf_source_data;                                      // calc_unit_used_s1_agent:rf_source_data -> calc_unit_used_s1_agent_rsp_fifo:in_data
	wire          calc_unit_used_s1_agent_rf_source_ready;                                     // calc_unit_used_s1_agent_rsp_fifo:in_ready -> calc_unit_used_s1_agent:rf_source_ready
	wire          calc_unit_used_s1_agent_rf_source_startofpacket;                             // calc_unit_used_s1_agent:rf_source_startofpacket -> calc_unit_used_s1_agent_rsp_fifo:in_startofpacket
	wire          calc_unit_used_s1_agent_rf_source_endofpacket;                               // calc_unit_used_s1_agent:rf_source_endofpacket -> calc_unit_used_s1_agent_rsp_fifo:in_endofpacket
	wire          calc_unit_used_s1_agent_rsp_fifo_out_valid;                                  // calc_unit_used_s1_agent_rsp_fifo:out_valid -> calc_unit_used_s1_agent:rf_sink_valid
	wire  [104:0] calc_unit_used_s1_agent_rsp_fifo_out_data;                                   // calc_unit_used_s1_agent_rsp_fifo:out_data -> calc_unit_used_s1_agent:rf_sink_data
	wire          calc_unit_used_s1_agent_rsp_fifo_out_ready;                                  // calc_unit_used_s1_agent:rf_sink_ready -> calc_unit_used_s1_agent_rsp_fifo:out_ready
	wire          calc_unit_used_s1_agent_rsp_fifo_out_startofpacket;                          // calc_unit_used_s1_agent_rsp_fifo:out_startofpacket -> calc_unit_used_s1_agent:rf_sink_startofpacket
	wire          calc_unit_used_s1_agent_rsp_fifo_out_endofpacket;                            // calc_unit_used_s1_agent_rsp_fifo:out_endofpacket -> calc_unit_used_s1_agent:rf_sink_endofpacket
	wire          calc_unit_used_s1_agent_rdata_fifo_src_valid;                                // calc_unit_used_s1_agent:rdata_fifo_src_valid -> calc_unit_used_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] calc_unit_used_s1_agent_rdata_fifo_src_data;                                 // calc_unit_used_s1_agent:rdata_fifo_src_data -> calc_unit_used_s1_agent:rdata_fifo_sink_data
	wire          calc_unit_used_s1_agent_rdata_fifo_src_ready;                                // calc_unit_used_s1_agent:rdata_fifo_sink_ready -> calc_unit_used_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_011_src_valid;                                                       // cmd_mux_011:src_valid -> calc_unit_used_s1_agent:cp_valid
	wire  [103:0] cmd_mux_011_src_data;                                                        // cmd_mux_011:src_data -> calc_unit_used_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                       // calc_unit_used_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [15:0] cmd_mux_011_src_channel;                                                     // cmd_mux_011:src_channel -> calc_unit_used_s1_agent:cp_channel
	wire          cmd_mux_011_src_startofpacket;                                               // cmd_mux_011:src_startofpacket -> calc_unit_used_s1_agent:cp_startofpacket
	wire          cmd_mux_011_src_endofpacket;                                                 // cmd_mux_011:src_endofpacket -> calc_unit_used_s1_agent:cp_endofpacket
	wire   [31:0] calc_unit_total_s1_agent_m0_readdata;                                        // calc_unit_total_s1_translator:uav_readdata -> calc_unit_total_s1_agent:m0_readdata
	wire          calc_unit_total_s1_agent_m0_waitrequest;                                     // calc_unit_total_s1_translator:uav_waitrequest -> calc_unit_total_s1_agent:m0_waitrequest
	wire          calc_unit_total_s1_agent_m0_debugaccess;                                     // calc_unit_total_s1_agent:m0_debugaccess -> calc_unit_total_s1_translator:uav_debugaccess
	wire   [16:0] calc_unit_total_s1_agent_m0_address;                                         // calc_unit_total_s1_agent:m0_address -> calc_unit_total_s1_translator:uav_address
	wire    [3:0] calc_unit_total_s1_agent_m0_byteenable;                                      // calc_unit_total_s1_agent:m0_byteenable -> calc_unit_total_s1_translator:uav_byteenable
	wire          calc_unit_total_s1_agent_m0_read;                                            // calc_unit_total_s1_agent:m0_read -> calc_unit_total_s1_translator:uav_read
	wire          calc_unit_total_s1_agent_m0_readdatavalid;                                   // calc_unit_total_s1_translator:uav_readdatavalid -> calc_unit_total_s1_agent:m0_readdatavalid
	wire          calc_unit_total_s1_agent_m0_lock;                                            // calc_unit_total_s1_agent:m0_lock -> calc_unit_total_s1_translator:uav_lock
	wire   [31:0] calc_unit_total_s1_agent_m0_writedata;                                       // calc_unit_total_s1_agent:m0_writedata -> calc_unit_total_s1_translator:uav_writedata
	wire          calc_unit_total_s1_agent_m0_write;                                           // calc_unit_total_s1_agent:m0_write -> calc_unit_total_s1_translator:uav_write
	wire    [2:0] calc_unit_total_s1_agent_m0_burstcount;                                      // calc_unit_total_s1_agent:m0_burstcount -> calc_unit_total_s1_translator:uav_burstcount
	wire          calc_unit_total_s1_agent_rf_source_valid;                                    // calc_unit_total_s1_agent:rf_source_valid -> calc_unit_total_s1_agent_rsp_fifo:in_valid
	wire  [104:0] calc_unit_total_s1_agent_rf_source_data;                                     // calc_unit_total_s1_agent:rf_source_data -> calc_unit_total_s1_agent_rsp_fifo:in_data
	wire          calc_unit_total_s1_agent_rf_source_ready;                                    // calc_unit_total_s1_agent_rsp_fifo:in_ready -> calc_unit_total_s1_agent:rf_source_ready
	wire          calc_unit_total_s1_agent_rf_source_startofpacket;                            // calc_unit_total_s1_agent:rf_source_startofpacket -> calc_unit_total_s1_agent_rsp_fifo:in_startofpacket
	wire          calc_unit_total_s1_agent_rf_source_endofpacket;                              // calc_unit_total_s1_agent:rf_source_endofpacket -> calc_unit_total_s1_agent_rsp_fifo:in_endofpacket
	wire          calc_unit_total_s1_agent_rsp_fifo_out_valid;                                 // calc_unit_total_s1_agent_rsp_fifo:out_valid -> calc_unit_total_s1_agent:rf_sink_valid
	wire  [104:0] calc_unit_total_s1_agent_rsp_fifo_out_data;                                  // calc_unit_total_s1_agent_rsp_fifo:out_data -> calc_unit_total_s1_agent:rf_sink_data
	wire          calc_unit_total_s1_agent_rsp_fifo_out_ready;                                 // calc_unit_total_s1_agent:rf_sink_ready -> calc_unit_total_s1_agent_rsp_fifo:out_ready
	wire          calc_unit_total_s1_agent_rsp_fifo_out_startofpacket;                         // calc_unit_total_s1_agent_rsp_fifo:out_startofpacket -> calc_unit_total_s1_agent:rf_sink_startofpacket
	wire          calc_unit_total_s1_agent_rsp_fifo_out_endofpacket;                           // calc_unit_total_s1_agent_rsp_fifo:out_endofpacket -> calc_unit_total_s1_agent:rf_sink_endofpacket
	wire          calc_unit_total_s1_agent_rdata_fifo_src_valid;                               // calc_unit_total_s1_agent:rdata_fifo_src_valid -> calc_unit_total_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] calc_unit_total_s1_agent_rdata_fifo_src_data;                                // calc_unit_total_s1_agent:rdata_fifo_src_data -> calc_unit_total_s1_agent:rdata_fifo_sink_data
	wire          calc_unit_total_s1_agent_rdata_fifo_src_ready;                               // calc_unit_total_s1_agent:rdata_fifo_sink_ready -> calc_unit_total_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_012_src_valid;                                                       // cmd_mux_012:src_valid -> calc_unit_total_s1_agent:cp_valid
	wire  [103:0] cmd_mux_012_src_data;                                                        // cmd_mux_012:src_data -> calc_unit_total_s1_agent:cp_data
	wire          cmd_mux_012_src_ready;                                                       // calc_unit_total_s1_agent:cp_ready -> cmd_mux_012:src_ready
	wire   [15:0] cmd_mux_012_src_channel;                                                     // cmd_mux_012:src_channel -> calc_unit_total_s1_agent:cp_channel
	wire          cmd_mux_012_src_startofpacket;                                               // cmd_mux_012:src_startofpacket -> calc_unit_total_s1_agent:cp_startofpacket
	wire          cmd_mux_012_src_endofpacket;                                                 // cmd_mux_012:src_endofpacket -> calc_unit_total_s1_agent:cp_endofpacket
	wire   [31:0] wr_ddrvld_s1_agent_m0_readdata;                                              // wr_ddrvld_s1_translator:uav_readdata -> wr_ddrvld_s1_agent:m0_readdata
	wire          wr_ddrvld_s1_agent_m0_waitrequest;                                           // wr_ddrvld_s1_translator:uav_waitrequest -> wr_ddrvld_s1_agent:m0_waitrequest
	wire          wr_ddrvld_s1_agent_m0_debugaccess;                                           // wr_ddrvld_s1_agent:m0_debugaccess -> wr_ddrvld_s1_translator:uav_debugaccess
	wire   [16:0] wr_ddrvld_s1_agent_m0_address;                                               // wr_ddrvld_s1_agent:m0_address -> wr_ddrvld_s1_translator:uav_address
	wire    [3:0] wr_ddrvld_s1_agent_m0_byteenable;                                            // wr_ddrvld_s1_agent:m0_byteenable -> wr_ddrvld_s1_translator:uav_byteenable
	wire          wr_ddrvld_s1_agent_m0_read;                                                  // wr_ddrvld_s1_agent:m0_read -> wr_ddrvld_s1_translator:uav_read
	wire          wr_ddrvld_s1_agent_m0_readdatavalid;                                         // wr_ddrvld_s1_translator:uav_readdatavalid -> wr_ddrvld_s1_agent:m0_readdatavalid
	wire          wr_ddrvld_s1_agent_m0_lock;                                                  // wr_ddrvld_s1_agent:m0_lock -> wr_ddrvld_s1_translator:uav_lock
	wire   [31:0] wr_ddrvld_s1_agent_m0_writedata;                                             // wr_ddrvld_s1_agent:m0_writedata -> wr_ddrvld_s1_translator:uav_writedata
	wire          wr_ddrvld_s1_agent_m0_write;                                                 // wr_ddrvld_s1_agent:m0_write -> wr_ddrvld_s1_translator:uav_write
	wire    [2:0] wr_ddrvld_s1_agent_m0_burstcount;                                            // wr_ddrvld_s1_agent:m0_burstcount -> wr_ddrvld_s1_translator:uav_burstcount
	wire          wr_ddrvld_s1_agent_rf_source_valid;                                          // wr_ddrvld_s1_agent:rf_source_valid -> wr_ddrvld_s1_agent_rsp_fifo:in_valid
	wire  [104:0] wr_ddrvld_s1_agent_rf_source_data;                                           // wr_ddrvld_s1_agent:rf_source_data -> wr_ddrvld_s1_agent_rsp_fifo:in_data
	wire          wr_ddrvld_s1_agent_rf_source_ready;                                          // wr_ddrvld_s1_agent_rsp_fifo:in_ready -> wr_ddrvld_s1_agent:rf_source_ready
	wire          wr_ddrvld_s1_agent_rf_source_startofpacket;                                  // wr_ddrvld_s1_agent:rf_source_startofpacket -> wr_ddrvld_s1_agent_rsp_fifo:in_startofpacket
	wire          wr_ddrvld_s1_agent_rf_source_endofpacket;                                    // wr_ddrvld_s1_agent:rf_source_endofpacket -> wr_ddrvld_s1_agent_rsp_fifo:in_endofpacket
	wire          wr_ddrvld_s1_agent_rsp_fifo_out_valid;                                       // wr_ddrvld_s1_agent_rsp_fifo:out_valid -> wr_ddrvld_s1_agent:rf_sink_valid
	wire  [104:0] wr_ddrvld_s1_agent_rsp_fifo_out_data;                                        // wr_ddrvld_s1_agent_rsp_fifo:out_data -> wr_ddrvld_s1_agent:rf_sink_data
	wire          wr_ddrvld_s1_agent_rsp_fifo_out_ready;                                       // wr_ddrvld_s1_agent:rf_sink_ready -> wr_ddrvld_s1_agent_rsp_fifo:out_ready
	wire          wr_ddrvld_s1_agent_rsp_fifo_out_startofpacket;                               // wr_ddrvld_s1_agent_rsp_fifo:out_startofpacket -> wr_ddrvld_s1_agent:rf_sink_startofpacket
	wire          wr_ddrvld_s1_agent_rsp_fifo_out_endofpacket;                                 // wr_ddrvld_s1_agent_rsp_fifo:out_endofpacket -> wr_ddrvld_s1_agent:rf_sink_endofpacket
	wire          wr_ddrvld_s1_agent_rdata_fifo_src_valid;                                     // wr_ddrvld_s1_agent:rdata_fifo_src_valid -> wr_ddrvld_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] wr_ddrvld_s1_agent_rdata_fifo_src_data;                                      // wr_ddrvld_s1_agent:rdata_fifo_src_data -> wr_ddrvld_s1_agent:rdata_fifo_sink_data
	wire          wr_ddrvld_s1_agent_rdata_fifo_src_ready;                                     // wr_ddrvld_s1_agent:rdata_fifo_sink_ready -> wr_ddrvld_s1_agent:rdata_fifo_src_ready
	wire          cmd_mux_013_src_valid;                                                       // cmd_mux_013:src_valid -> wr_ddrvld_s1_agent:cp_valid
	wire  [103:0] cmd_mux_013_src_data;                                                        // cmd_mux_013:src_data -> wr_ddrvld_s1_agent:cp_data
	wire          cmd_mux_013_src_ready;                                                       // wr_ddrvld_s1_agent:cp_ready -> cmd_mux_013:src_ready
	wire   [15:0] cmd_mux_013_src_channel;                                                     // cmd_mux_013:src_channel -> wr_ddrvld_s1_agent:cp_channel
	wire          cmd_mux_013_src_startofpacket;                                               // cmd_mux_013:src_startofpacket -> wr_ddrvld_s1_agent:cp_startofpacket
	wire          cmd_mux_013_src_endofpacket;                                                 // cmd_mux_013:src_endofpacket -> wr_ddrvld_s1_agent:cp_endofpacket
	...
	wire   [16:0] power_temp_scl_s1_agent_m0_address;                                          // power_temp_scl_s1_agent:m0_address -> power_temp_scl_s1_translator:uav_address
	...
	wire  [104:0] power_temp_scl_s1_agent_rf_source_data;                                      // power_temp_scl_s1_agent:rf_source_data -> power_temp_scl_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] power_temp_scl_s1_agent_rsp_fifo_out_data;                                   // power_temp_scl_s1_agent_rsp_fifo:out_data -> power_temp_scl_s1_agent:rf_sink_data
	...
	wire          cmd_mux_014_src_valid;                                                       // cmd_mux_014:src_valid -> power_temp_scl_s1_agent:cp_valid
	wire  [103:0] cmd_mux_014_src_data;                                                        // cmd_mux_014:src_data -> power_temp_scl_s1_agent:cp_data
	wire          cmd_mux_014_src_ready;                                                       // power_temp_scl_s1_agent:cp_ready -> cmd_mux_014:src_ready
	wire   [15:0] cmd_mux_014_src_channel;                                                     // cmd_mux_014:src_channel -> power_temp_scl_s1_agent:cp_channel
	wire          cmd_mux_014_src_startofpacket;                                               // cmd_mux_014:src_startofpacket -> power_temp_scl_s1_agent:cp_startofpacket
	wire          cmd_mux_014_src_endofpacket;                                                 // cmd_mux_014:src_endofpacket -> power_temp_scl_s1_agent:cp_endofpacket
	...
	wire   [16:0] power_temp_sda_s1_agent_m0_address;                                          // power_temp_sda_s1_agent:m0_address -> power_temp_sda_s1_translator:uav_address
	...
	wire  [104:0] power_temp_sda_s1_agent_rf_source_data;                                      // power_temp_sda_s1_agent:rf_source_data -> power_temp_sda_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] power_temp_sda_s1_agent_rsp_fifo_out_data;                                   // power_temp_sda_s1_agent_rsp_fifo:out_data -> power_temp_sda_s1_agent:rf_sink_data
	...
	wire          cmd_mux_015_src_valid;                                                       // cmd_mux_015:src_valid -> power_temp_sda_s1_agent:cp_valid
	wire  [103:0] cmd_mux_015_src_data;                                                        // cmd_mux_015:src_data -> power_temp_sda_s1_agent:cp_data
	wire          cmd_mux_015_src_ready;                                                       // power_temp_sda_s1_agent:cp_ready -> cmd_mux_015:src_ready
	wire   [15:0] cmd_mux_015_src_channel;                                                     // cmd_mux_015:src_channel -> power_temp_sda_s1_agent:cp_channel
	wire          cmd_mux_015_src_startofpacket;                                               // cmd_mux_015:src_startofpacket -> power_temp_sda_s1_agent:cp_startofpacket
	wire          cmd_mux_015_src_endofpacket;                                                 // cmd_mux_015:src_endofpacket -> power_temp_sda_s1_agent:cp_endofpacket
	...
	wire          calc_unit_used_s1_agent_rp_valid;                                            // calc_unit_used_s1_agent:rp_valid -> router_013:sink_valid
	wire  [103:0] calc_unit_used_s1_agent_rp_data;                                             // calc_unit_used_s1_agent:rp_data -> router_013:sink_data
	wire          calc_unit_used_s1_agent_rp_ready;                                            // router_013:sink_ready -> calc_unit_used_s1_agent:rp_ready
	wire          calc_unit_used_s1_agent_rp_startofpacket;                                    // calc_unit_used_s1_agent:rp_startofpacket -> router_013:sink_startofpacket
	wire          calc_unit_used_s1_agent_rp_endofpacket;                                      // calc_unit_used_s1_agent:rp_endofpacket -> router_013:sink_endofpacket
	...
	wire          calc_unit_total_s1_agent_rp_valid;                                           // calc_unit_total_s1_agent:rp_valid -> router_014:sink_valid
	wire  [103:0] calc_unit_total_s1_agent_rp_data;                                            // calc_unit_total_s1_agent:rp_data -> router_014:sink_data
	wire          calc_unit_total_s1_agent_rp_ready;                                           // router_014:sink_ready -> calc_unit_total_s1_agent:rp_ready
	wire          calc_unit_total_s1_agent_rp_startofpacket;                                   // calc_unit_total_s1_agent:rp_startofpacket -> router_014:sink_startofpacket
	wire          calc_unit_total_s1_agent_rp_endofpacket;                                     // calc_unit_total_s1_agent:rp_endofpacket -> router_014:sink_endofpacket
	...
	wire          wr_ddrvld_s1_agent_rp_valid;                                                 // wr_ddrvld_s1_agent:rp_valid -> router_015:sink_valid
	wire  [103:0] wr_ddrvld_s1_agent_rp_data;                                                  // wr_ddrvld_s1_agent:rp_data -> router_015:sink_data
	wire          wr_ddrvld_s1_agent_rp_ready;                                                 // router_015:sink_ready -> wr_ddrvld_s1_agent:rp_ready
	wire          wr_ddrvld_s1_agent_rp_startofpacket;                                         // wr_ddrvld_s1_agent:rp_startofpacket -> router_015:sink_startofpacket
	wire          wr_ddrvld_s1_agent_rp_endofpacket;                                           // wr_ddrvld_s1_agent:rp_endofpacket -> router_015:sink_endofpacket
	...
	wire          power_temp_scl_s1_agent_rp_valid;                                            // power_temp_scl_s1_agent:rp_valid -> router_016:sink_valid
	wire  [103:0] power_temp_scl_s1_agent_rp_data;                                             // power_temp_scl_s1_agent:rp_data -> router_016:sink_data
	wire          power_temp_scl_s1_agent_rp_ready;                                            // router_016:sink_ready -> power_temp_scl_s1_agent:rp_ready
	wire          power_temp_scl_s1_agent_rp_startofpacket;                                    // power_temp_scl_s1_agent:rp_startofpacket -> router_016:sink_startofpacket
	wire          power_temp_scl_s1_agent_rp_endofpacket;                                      // power_temp_scl_s1_agent:rp_endofpacket -> router_016:sink_endofpacket
	...
	wire          power_temp_sda_s1_agent_rp_valid;                                            // power_temp_sda_s1_agent:rp_valid -> router_017:sink_valid
	wire  [103:0] power_temp_sda_s1_agent_rp_data;                                             // power_temp_sda_s1_agent:rp_data -> router_017:sink_data
	wire          power_temp_sda_s1_agent_rp_ready;                                            // router_017:sink_ready -> power_temp_sda_s1_agent:rp_ready
	wire          power_temp_sda_s1_agent_rp_startofpacket;                                    // power_temp_sda_s1_agent:rp_startofpacket -> router_017:sink_startofpacket
	wire          power_temp_sda_s1_agent_rp_endofpacket;                                      // power_temp_sda_s1_agent:rp_endofpacket -> router_017:sink_endofpacket
	...
	wire   [15:0] router_src_channel;                                                          // router:src_channel -> nios2_data_master_limiter:cmd_sink_channel
	...
	wire   [15:0] nios2_data_master_limiter_cmd_src_channel;                                   // nios2_data_master_limiter:cmd_src_channel -> cmd_demux:sink_channel
	...
	wire   [15:0] rsp_mux_src_channel;                                                         // rsp_mux:src_channel -> nios2_data_master_limiter:rsp_sink_channel
	...
	wire   [15:0] router_001_src_channel;                                                      // router_001:src_channel -> nios2_instruction_master_limiter:cmd_sink_channel
	...
	wire   [15:0] nios2_instruction_master_limiter_cmd_src_channel;                            // nios2_instruction_master_limiter:cmd_src_channel -> cmd_demux_001:sink_channel
	...
	wire   [15:0] rsp_mux_001_src_channel;                                                     // rsp_mux_001:src_channel -> nios2_instruction_master_limiter:rsp_sink_channel
	...
	wire   [15:0] nios2_data_master_limiter_cmd_valid_data;                                    // nios2_data_master_limiter:cmd_src_valid -> cmd_demux:sink_valid
	wire   [15:0] nios2_instruction_master_limiter_cmd_valid_data;                             // nios2_instruction_master_limiter:cmd_src_valid -> cmd_demux_001:sink_valid
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) calc_unit_used_s1_translator (
		.clk                    (clock_in_out_clk_clk),                     //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),  //   input,   width = 1,                    reset.reset
		.uav_address            (calc_unit_used_s1_agent_m0_address),       //   input,  width = 17, avalon_universal_slave_0.address
		.uav_burstcount         (calc_unit_used_s1_agent_m0_burstcount),    //   input,   width = 3,                         .burstcount
		.uav_read               (calc_unit_used_s1_agent_m0_read),          //   input,   width = 1,                         .read
		.uav_write              (calc_unit_used_s1_agent_m0_write),         //   input,   width = 1,                         .write
		.uav_waitrequest        (calc_unit_used_s1_agent_m0_waitrequest),   //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (calc_unit_used_s1_agent_m0_readdatavalid), //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (calc_unit_used_s1_agent_m0_byteenable),    //   input,   width = 4,                         .byteenable
		.uav_readdata           (calc_unit_used_s1_agent_m0_readdata),      //  output,  width = 32,                         .readdata
		.uav_writedata          (calc_unit_used_s1_agent_m0_writedata),     //   input,  width = 32,                         .writedata
		.uav_lock               (calc_unit_used_s1_agent_m0_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess        (calc_unit_used_s1_agent_m0_debugaccess),   //   input,   width = 1,                         .debugaccess
		.av_address             (calc_unit_used_s1_address),                //  output,   width = 2,      avalon_anti_slave_0.address
		.av_readdata            (calc_unit_used_s1_readdata),               //   input,  width = 32,                         .readdata
		.av_write               (),                                         // (terminated),                                       
		.av_read                (),                                         // (terminated),                                       
		.av_writedata           (),                                         // (terminated),                                       
		.av_begintransfer       (),                                         // (terminated),                                       
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) calc_unit_total_s1_translator (
		.clk                    (clock_in_out_clk_clk),                      //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset),   //   input,   width = 1,                    reset.reset
		.uav_address            (calc_unit_total_s1_agent_m0_address),       //   input,  width = 17, avalon_universal_slave_0.address
		.uav_burstcount         (calc_unit_total_s1_agent_m0_burstcount),    //   input,   width = 3,                         .burstcount
		.uav_read               (calc_unit_total_s1_agent_m0_read),          //   input,   width = 1,                         .read
		.uav_write              (calc_unit_total_s1_agent_m0_write),         //   input,   width = 1,                         .write
		.uav_waitrequest        (calc_unit_total_s1_agent_m0_waitrequest),   //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (calc_unit_total_s1_agent_m0_readdatavalid), //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (calc_unit_total_s1_agent_m0_byteenable),    //   input,   width = 4,                         .byteenable
		.uav_readdata           (calc_unit_total_s1_agent_m0_readdata),      //  output,  width = 32,                         .readdata
		.uav_writedata          (calc_unit_total_s1_agent_m0_writedata),     //   input,  width = 32,                         .writedata
		.uav_lock               (calc_unit_total_s1_agent_m0_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess        (calc_unit_total_s1_agent_m0_debugaccess),   //   input,   width = 1,                         .debugaccess
		.av_address             (calc_unit_total_s1_address),                //  output,   width = 2,      avalon_anti_slave_0.address
		.av_readdata            (calc_unit_total_s1_readdata),               //   input,  width = 32,                         .readdata
		.av_write               (),                                          // (terminated),                                       
		.av_read                (),                                          // (terminated),                                       
		.av_writedata           (),                                          // (terminated),                                       
		.av_begintransfer       (),                                          // (terminated),                                       
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.WAITREQUEST_ALLOWANCE          (0),
		.SYNC_RESET                     (0)
	) wr_ddrvld_s1_translator (
		.clk                    (clock_in_out_clk_clk),                    //   input,   width = 1,                      clk.clk
		.reset                  (nios2_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (wr_ddrvld_s1_agent_m0_address),           //   input,  width = 17, avalon_universal_slave_0.address
		.uav_burstcount         (wr_ddrvld_s1_agent_m0_burstcount),        //   input,   width = 3,                         .burstcount
		.uav_read               (wr_ddrvld_s1_agent_m0_read),              //   input,   width = 1,                         .read
		.uav_write              (wr_ddrvld_s1_agent_m0_write),             //   input,   width = 1,                         .write
		.uav_waitrequest        (wr_ddrvld_s1_agent_m0_waitrequest),       //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid      (wr_ddrvld_s1_agent_m0_readdatavalid),     //  output,   width = 1,                         .readdatavalid
		.uav_byteenable         (wr_ddrvld_s1_agent_m0_byteenable),        //   input,   width = 4,                         .byteenable
		.uav_readdata           (wr_ddrvld_s1_agent_m0_readdata),          //  output,  width = 32,                         .readdata
		.uav_writedata          (wr_ddrvld_s1_agent_m0_writedata),         //   input,  width = 32,                         .writedata
		.uav_lock               (wr_ddrvld_s1_agent_m0_lock),              //   input,   width = 1,                         .lock
		.uav_debugaccess        (wr_ddrvld_s1_agent_m0_debugaccess),       //   input,   width = 1,                         .debugaccess
		.av_address             (wr_ddrvld_s1_address),                    //  output,   width = 2,      avalon_anti_slave_0.address
		.av_readdata            (wr_ddrvld_s1_readdata),                   //   input,  width = 32,                         .readdata
		.av_write               (),                                        // (terminated),                                       
		.av_read                (),                                        // (terminated),                                       
		.av_writedata           (),                                        // (terminated),                                       
		.av_begintransfer       (),                                        // (terminated),                                       
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                             //   input,   width = 1,                      clk.clk
		.reset                  (power_temp_scl_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (power_temp_scl_s1_agent_m0_address),               //   input,  width = 17, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_slave_translator_181_5aswt6a #(
		...
		.clk                    (clock_in_out_clk_clk),                             //   input,   width = 1,                      clk.clk
		.reset                  (power_temp_scl_reset_reset_bridge_in_reset_reset), //   input,   width = 1,                    reset.reset
		.uav_address            (power_temp_sda_s1_agent_m0_address),               //   input,  width = 17, avalon_universal_slave_0.address
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.rp_channel            (nios2_data_master_limiter_rsp_src_channel),                            //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_master_agent_181_t5eyqrq #(
		...
		.rp_channel            (nios2_instruction_master_limiter_rsp_src_channel),                            //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_src_channel),                                     //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_001_src_channel),                              //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_002_src_channel),                                //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_003_src_channel),                        //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_004_src_channel),                       //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_005_src_channel),                         //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_006_src_channel),                       //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_007_src_channel),                      //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_008_src_channel),                   //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_009_src_channel),                         //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.cp_channel              (cmd_mux_010_src_channel),                           //   input,   width = 16,                .channel
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (0)
	) calc_unit_used_s1_agent (
		.clk                     (clock_in_out_clk_clk),                               //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),            //   input,    width = 1,       clk_reset.reset
		.m0_address              (calc_unit_used_s1_agent_m0_address),                 //  output,   width = 17,              m0.address
		.m0_burstcount           (calc_unit_used_s1_agent_m0_burstcount),              //  output,    width = 3,                .burstcount
		.m0_byteenable           (calc_unit_used_s1_agent_m0_byteenable),              //  output,    width = 4,                .byteenable
		.m0_debugaccess          (calc_unit_used_s1_agent_m0_debugaccess),             //  output,    width = 1,                .debugaccess
		.m0_lock                 (calc_unit_used_s1_agent_m0_lock),                    //  output,    width = 1,                .lock
		.m0_readdata             (calc_unit_used_s1_agent_m0_readdata),                //   input,   width = 32,                .readdata
		.m0_readdatavalid        (calc_unit_used_s1_agent_m0_readdatavalid),           //   input,    width = 1,                .readdatavalid
		.m0_read                 (calc_unit_used_s1_agent_m0_read),                    //  output,    width = 1,                .read
		.m0_waitrequest          (calc_unit_used_s1_agent_m0_waitrequest),             //   input,    width = 1,                .waitrequest
		.m0_writedata            (calc_unit_used_s1_agent_m0_writedata),               //  output,   width = 32,                .writedata
		.m0_write                (calc_unit_used_s1_agent_m0_write),                   //  output,    width = 1,                .write
		.rp_endofpacket          (calc_unit_used_s1_agent_rp_endofpacket),             //  output,    width = 1,              rp.endofpacket
		.rp_ready                (calc_unit_used_s1_agent_rp_ready),                   //   input,    width = 1,                .ready
		.rp_valid                (calc_unit_used_s1_agent_rp_valid),                   //  output,    width = 1,                .valid
		.rp_data                 (calc_unit_used_s1_agent_rp_data),                    //  output,  width = 104,                .data
		.rp_startofpacket        (calc_unit_used_s1_agent_rp_startofpacket),           //  output,    width = 1,                .startofpacket
		.cp_ready                (cmd_mux_011_src_ready),                              //  output,    width = 1,              cp.ready
		.cp_valid                (cmd_mux_011_src_valid),                              //   input,    width = 1,                .valid
		.cp_data                 (cmd_mux_011_src_data),                               //   input,  width = 104,                .data
		...
		.cp_channel              (cmd_mux_011_src_channel),                            //   input,   width = 16,                .channel
		.rf_sink_ready           (calc_unit_used_s1_agent_rsp_fifo_out_ready),         //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (calc_unit_used_s1_agent_rsp_fifo_out_valid),         //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (calc_unit_used_s1_agent_rsp_fifo_out_startofpacket), //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (calc_unit_used_s1_agent_rsp_fifo_out_endofpacket),   //   input,    width = 1,                .endofpacket
		.rf_sink_data            (calc_unit_used_s1_agent_rsp_fifo_out_data),          //   input,  width = 105,                .data
		.rf_source_ready         (calc_unit_used_s1_agent_rf_source_ready),            //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (calc_unit_used_s1_agent_rf_source_valid),            //  output,    width = 1,                .valid
		.rf_source_startofpacket (calc_unit_used_s1_agent_rf_source_startofpacket),    //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (calc_unit_used_s1_agent_rf_source_endofpacket),      //  output,    width = 1,                .endofpacket
		.rf_source_data          (calc_unit_used_s1_agent_rf_source_data),             //  output,  width = 105,                .data
		.rdata_fifo_sink_ready   (calc_unit_used_s1_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (calc_unit_used_s1_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (calc_unit_used_s1_agent_rdata_fifo_src_data),        //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (calc_unit_used_s1_agent_rdata_fifo_src_ready),       //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (calc_unit_used_s1_agent_rdata_fifo_src_valid),       //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (calc_unit_used_s1_agent_rdata_fifo_src_data),        //  output,   width = 34,                .data
		.m0_response             (2'b00),                                              // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                               // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                // (terminated),                               
	);
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) calc_unit_used_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                               //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),            //   input,    width = 1, clk_reset.reset
		.in_data           (calc_unit_used_s1_agent_rf_source_data),             //   input,  width = 105,        in.data
		.in_valid          (calc_unit_used_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (calc_unit_used_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (calc_unit_used_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (calc_unit_used_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (calc_unit_used_s1_agent_rsp_fifo_out_data),          //  output,  width = 105,       out.data
		.out_valid         (calc_unit_used_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (calc_unit_used_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (calc_unit_used_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (calc_unit_used_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                              // (terminated),                         
		.csr_read          (1'b0),                                               // (terminated),                         
		.csr_write         (1'b0),                                               // (terminated),                         
		.csr_readdata      (),                                                   // (terminated),                         
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.ECC_ENABLE                (0),
		.SYNC_RESET                (0)
	) calc_unit_total_s1_agent (
		.clk                     (clock_in_out_clk_clk),                                //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),             //   input,    width = 1,       clk_reset.reset
		.m0_address              (calc_unit_total_s1_agent_m0_address),                 //  output,   width = 17,              m0.address
		.m0_burstcount           (calc_unit_total_s1_agent_m0_burstcount),              //  output,    width = 3,                .burstcount
		.m0_byteenable           (calc_unit_total_s1_agent_m0_byteenable),              //  output,    width = 4,                .byteenable
		.m0_debugaccess          (calc_unit_total_s1_agent_m0_debugaccess),             //  output,    width = 1,                .debugaccess
		.m0_lock                 (calc_unit_total_s1_agent_m0_lock),                    //  output,    width = 1,                .lock
		.m0_readdata             (calc_unit_total_s1_agent_m0_readdata),                //   input,   width = 32,                .readdata
		.m0_readdatavalid        (calc_unit_total_s1_agent_m0_readdatavalid),           //   input,    width = 1,                .readdatavalid
		.m0_read                 (calc_unit_total_s1_agent_m0_read),                    //  output,    width = 1,                .read
		.m0_waitrequest          (calc_unit_total_s1_agent_m0_waitrequest),             //   input,    width = 1,                .waitrequest
		.m0_writedata            (calc_unit_total_s1_agent_m0_writedata),               //  output,   width = 32,                .writedata
		.m0_write                (calc_unit_total_s1_agent_m0_write),                   //  output,    width = 1,                .write
		.rp_endofpacket          (calc_unit_total_s1_agent_rp_endofpacket),             //  output,    width = 1,              rp.endofpacket
		.rp_ready                (calc_unit_total_s1_agent_rp_ready),                   //   input,    width = 1,                .ready
		.rp_valid                (calc_unit_total_s1_agent_rp_valid),                   //  output,    width = 1,                .valid
		.rp_data                 (calc_unit_total_s1_agent_rp_data),                    //  output,  width = 104,                .data
		.rp_startofpacket        (calc_unit_total_s1_agent_rp_startofpacket),           //  output,    width = 1,                .startofpacket
		.cp_ready                (cmd_mux_012_src_ready),                               //  output,    width = 1,              cp.ready
		.cp_valid                (cmd_mux_012_src_valid),                               //   input,    width = 1,                .valid
		.cp_data                 (cmd_mux_012_src_data),                                //   input,  width = 104,                .data
		...
		.cp_channel              (cmd_mux_012_src_channel),                             //   input,   width = 16,                .channel
		.rf_sink_ready           (calc_unit_total_s1_agent_rsp_fifo_out_ready),         //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (calc_unit_total_s1_agent_rsp_fifo_out_valid),         //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (calc_unit_total_s1_agent_rsp_fifo_out_startofpacket), //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (calc_unit_total_s1_agent_rsp_fifo_out_endofpacket),   //   input,    width = 1,                .endofpacket
		.rf_sink_data            (calc_unit_total_s1_agent_rsp_fifo_out_data),          //   input,  width = 105,                .data
		.rf_source_ready         (calc_unit_total_s1_agent_rf_source_ready),            //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (calc_unit_total_s1_agent_rf_source_valid),            //  output,    width = 1,                .valid
		.rf_source_startofpacket (calc_unit_total_s1_agent_rf_source_startofpacket),    //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (calc_unit_total_s1_agent_rf_source_endofpacket),      //  output,    width = 1,                .endofpacket
		.rf_source_data          (calc_unit_total_s1_agent_rf_source_data),             //  output,  width = 105,                .data
		.rdata_fifo_sink_ready   (calc_unit_total_s1_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (calc_unit_total_s1_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (calc_unit_total_s1_agent_rdata_fifo_src_data),        //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (calc_unit_total_s1_agent_rdata_fifo_src_ready),       //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (calc_unit_total_s1_agent_rdata_fifo_src_valid),       //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (calc_unit_total_s1_agent_rdata_fifo_src_data),        //  output,   width = 34,                .data
		.m0_response             (2'b00),                                               // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                                // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                                 // (terminated),                               
	);
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) calc_unit_total_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                                //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),             //   input,    width = 1, clk_reset.reset
		.in_data           (calc_unit_total_s1_agent_rf_source_data),             //   input,  width = 105,        in.data
		.in_valid          (calc_unit_total_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (calc_unit_total_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (calc_unit_total_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (calc_unit_total_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (calc_unit_total_s1_agent_rsp_fifo_out_data),          //  output,  width = 105,       out.data
		.out_valid         (calc_unit_total_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (calc_unit_total_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (calc_unit_total_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (calc_unit_total_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                               // (terminated),                         
		.csr_read          (1'b0),                                                // (terminated),                         
		.csr_write         (1'b0),                                                // (terminated),                         
		.csr_readdata      (),                                                    // (terminated),                         
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                          //   input,    width = 1,             clk.clk
		.reset                   (nios2_reset_reset_bridge_in_reset_reset),       //   input,    width = 1,       clk_reset.reset
		.m0_address              (wr_ddrvld_s1_agent_m0_address),                 //  output,   width = 17,              m0.address
		.m0_burstcount           (wr_ddrvld_s1_agent_m0_burstcount),              //  output,    width = 3,                .burstcount
		.m0_byteenable           (wr_ddrvld_s1_agent_m0_byteenable),              //  output,    width = 4,                .byteenable
		.m0_debugaccess          (wr_ddrvld_s1_agent_m0_debugaccess),             //  output,    width = 1,                .debugaccess
		.m0_lock                 (wr_ddrvld_s1_agent_m0_lock),                    //  output,    width = 1,                .lock
		.m0_readdata             (wr_ddrvld_s1_agent_m0_readdata),                //   input,   width = 32,                .readdata
		.m0_readdatavalid        (wr_ddrvld_s1_agent_m0_readdatavalid),           //   input,    width = 1,                .readdatavalid
		.m0_read                 (wr_ddrvld_s1_agent_m0_read),                    //  output,    width = 1,                .read
		.m0_waitrequest          (wr_ddrvld_s1_agent_m0_waitrequest),             //   input,    width = 1,                .waitrequest
		.m0_writedata            (wr_ddrvld_s1_agent_m0_writedata),               //  output,   width = 32,                .writedata
		.m0_write                (wr_ddrvld_s1_agent_m0_write),                   //  output,    width = 1,                .write
		.rp_endofpacket          (wr_ddrvld_s1_agent_rp_endofpacket),             //  output,    width = 1,              rp.endofpacket
		.rp_ready                (wr_ddrvld_s1_agent_rp_ready),                   //   input,    width = 1,                .ready
		.rp_valid                (wr_ddrvld_s1_agent_rp_valid),                   //  output,    width = 1,                .valid
		.rp_data                 (wr_ddrvld_s1_agent_rp_data),                    //  output,  width = 104,                .data
		.rp_startofpacket        (wr_ddrvld_s1_agent_rp_startofpacket),           //  output,    width = 1,                .startofpacket
		.cp_ready                (cmd_mux_013_src_ready),                         //  output,    width = 1,              cp.ready
		.cp_valid                (cmd_mux_013_src_valid),                         //   input,    width = 1,                .valid
		.cp_data                 (cmd_mux_013_src_data),                          //   input,  width = 104,                .data
		...
		.cp_channel              (cmd_mux_013_src_channel),                       //   input,   width = 16,                .channel
		.rf_sink_ready           (wr_ddrvld_s1_agent_rsp_fifo_out_ready),         //  output,    width = 1,         rf_sink.ready
		.rf_sink_valid           (wr_ddrvld_s1_agent_rsp_fifo_out_valid),         //   input,    width = 1,                .valid
		.rf_sink_startofpacket   (wr_ddrvld_s1_agent_rsp_fifo_out_startofpacket), //   input,    width = 1,                .startofpacket
		.rf_sink_endofpacket     (wr_ddrvld_s1_agent_rsp_fifo_out_endofpacket),   //   input,    width = 1,                .endofpacket
		.rf_sink_data            (wr_ddrvld_s1_agent_rsp_fifo_out_data),          //   input,  width = 105,                .data
		.rf_source_ready         (wr_ddrvld_s1_agent_rf_source_ready),            //   input,    width = 1,       rf_source.ready
		.rf_source_valid         (wr_ddrvld_s1_agent_rf_source_valid),            //  output,    width = 1,                .valid
		.rf_source_startofpacket (wr_ddrvld_s1_agent_rf_source_startofpacket),    //  output,    width = 1,                .startofpacket
		.rf_source_endofpacket   (wr_ddrvld_s1_agent_rf_source_endofpacket),      //  output,    width = 1,                .endofpacket
		.rf_source_data          (wr_ddrvld_s1_agent_rf_source_data),             //  output,  width = 105,                .data
		.rdata_fifo_sink_ready   (wr_ddrvld_s1_agent_rdata_fifo_src_ready),       //  output,    width = 1, rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (wr_ddrvld_s1_agent_rdata_fifo_src_valid),       //   input,    width = 1,                .valid
		.rdata_fifo_sink_data    (wr_ddrvld_s1_agent_rdata_fifo_src_data),        //   input,   width = 34,                .data
		.rdata_fifo_src_ready    (wr_ddrvld_s1_agent_rdata_fifo_src_ready),       //   input,    width = 1,  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (wr_ddrvld_s1_agent_rdata_fifo_src_valid),       //  output,    width = 1,                .valid
		.rdata_fifo_src_data     (wr_ddrvld_s1_agent_rdata_fifo_src_data),        //  output,   width = 34,                .data
		.m0_response             (2'b00),                                         // (terminated),                               
		.m0_writeresponsevalid   (1'b0),                                          // (terminated),                               
		.rdata_fifo_sink_error   (1'b0)                                           // (terminated),                               
	);
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.USE_ALMOST_FULL_IF  (0),
		.USE_ALMOST_EMPTY_IF (0)
	) wr_ddrvld_s1_agent_rsp_fifo (
		.clk               (clock_in_out_clk_clk),                          //   input,    width = 1,       clk.clk
		.reset             (nios2_reset_reset_bridge_in_reset_reset),       //   input,    width = 1, clk_reset.reset
		.in_data           (wr_ddrvld_s1_agent_rf_source_data),             //   input,  width = 105,        in.data
		.in_valid          (wr_ddrvld_s1_agent_rf_source_valid),            //   input,    width = 1,          .valid
		.in_ready          (wr_ddrvld_s1_agent_rf_source_ready),            //  output,    width = 1,          .ready
		.in_startofpacket  (wr_ddrvld_s1_agent_rf_source_startofpacket),    //   input,    width = 1,          .startofpacket
		.in_endofpacket    (wr_ddrvld_s1_agent_rf_source_endofpacket),      //   input,    width = 1,          .endofpacket
		.out_data          (wr_ddrvld_s1_agent_rsp_fifo_out_data),          //  output,  width = 105,       out.data
		.out_valid         (wr_ddrvld_s1_agent_rsp_fifo_out_valid),         //  output,    width = 1,          .valid
		.out_ready         (wr_ddrvld_s1_agent_rsp_fifo_out_ready),         //   input,    width = 1,          .ready
		.out_startofpacket (wr_ddrvld_s1_agent_rsp_fifo_out_startofpacket), //  output,    width = 1,          .startofpacket
		.out_endofpacket   (wr_ddrvld_s1_agent_rsp_fifo_out_endofpacket),   //  output,    width = 1,          .endofpacket
		.csr_address       (2'b00),                                         // (terminated),                         
		.csr_read          (1'b0),                                          // (terminated),                         
		.csr_write         (1'b0),                                          // (terminated),                         
		.csr_readdata      (),                                              // (terminated),                         
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                               //   input,    width = 1,             clk.clk
		.reset                   (power_temp_scl_reset_reset_bridge_in_reset_reset),   //   input,    width = 1,       clk_reset.reset
		.m0_address              (power_temp_scl_s1_agent_m0_address),                 //  output,   width = 17,              m0.address
		...
		.rp_data                 (power_temp_scl_s1_agent_rp_data),                    //  output,  width = 104,                .data
		...
		.cp_data                 (cmd_mux_014_src_data),                               //   input,  width = 104,                .data
		...
		.cp_channel              (cmd_mux_014_src_channel),                            //   input,   width = 16,                .channel
		...
		.rf_sink_data            (power_temp_scl_s1_agent_rsp_fifo_out_data),          //   input,  width = 105,                .data
		...
		.rf_source_data          (power_temp_scl_s1_agent_rf_source_data),             //  output,  width = 105,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                               //   input,    width = 1,       clk.clk
		.reset             (power_temp_scl_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.in_data           (power_temp_scl_s1_agent_rf_source_data),             //   input,  width = 105,        in.data
		...
		.out_data          (power_temp_scl_s1_agent_rsp_fifo_out_data),          //  output,  width = 105,       out.data
	...
	nios_qsys_altera_merlin_slave_agent_181_a7g37xa #(
		...
		.clk                     (clock_in_out_clk_clk),                               //   input,    width = 1,             clk.clk
		.reset                   (power_temp_scl_reset_reset_bridge_in_reset_reset),   //   input,    width = 1,       clk_reset.reset
		.m0_address              (power_temp_sda_s1_agent_m0_address),                 //  output,   width = 17,              m0.address
		...
		.rp_data                 (power_temp_sda_s1_agent_rp_data),                    //  output,  width = 104,                .data
		...
		.cp_data                 (cmd_mux_015_src_data),                               //   input,  width = 104,                .data
		...
		.cp_channel              (cmd_mux_015_src_channel),                            //   input,   width = 16,                .channel
		...
		.rf_sink_data            (power_temp_sda_s1_agent_rsp_fifo_out_data),          //   input,  width = 105,                .data
		...
		.rf_source_data          (power_temp_sda_s1_agent_rf_source_data),             //  output,  width = 105,                .data
	...
	nios_qsys_altera_avalon_sc_fifo_181_hseo73i #(
		...
		.clk               (clock_in_out_clk_clk),                               //   input,    width = 1,       clk.clk
		.reset             (power_temp_scl_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.in_data           (power_temp_sda_s1_agent_rf_source_data),             //   input,  width = 105,        in.data
		...
		.out_data          (power_temp_sda_s1_agent_rsp_fifo_out_data),          //  output,  width = 105,       out.data
	...
	nios_qsys_altera_merlin_router_181_63lvjsa router (
	...
	nios_qsys_altera_merlin_router_181_7wiumbq router_001 (
	...
	nios_qsys_altera_merlin_router_181_zhkntci router_002 (
	...
	nios_qsys_altera_merlin_router_181_zhkntci router_003 (
	...
	nios_qsys_altera_merlin_router_181_zhkntci router_004 (
	...
	nios_qsys_altera_merlin_router_181_zhkntci router_005 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_006 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_007 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_008 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_009 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_010 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_011 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_012 (
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_013 (
		.sink_ready         (calc_unit_used_s1_agent_rp_ready),         //  output,    width = 1,      sink.ready
		.sink_valid         (calc_unit_used_s1_agent_rp_valid),         //   input,    width = 1,          .valid
		.sink_data          (calc_unit_used_s1_agent_rp_data),          //   input,  width = 104,          .data
		.sink_startofpacket (calc_unit_used_s1_agent_rp_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (calc_unit_used_s1_agent_rp_endofpacket),   //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                     //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),  //   input,    width = 1, clk_reset.reset
		.src_ready          (router_013_src_ready),                     //   input,    width = 1,       src.ready
		.src_valid          (router_013_src_valid),                     //  output,    width = 1,          .valid
		.src_data           (router_013_src_data),                      //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_014 (
		.sink_ready         (calc_unit_total_s1_agent_rp_ready),         //  output,    width = 1,      sink.ready
		.sink_valid         (calc_unit_total_s1_agent_rp_valid),         //   input,    width = 1,          .valid
		.sink_data          (calc_unit_total_s1_agent_rp_data),          //   input,  width = 104,          .data
		.sink_startofpacket (calc_unit_total_s1_agent_rp_startofpacket), //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (calc_unit_total_s1_agent_rp_endofpacket),   //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                      //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),   //   input,    width = 1, clk_reset.reset
		.src_ready          (router_014_src_ready),                      //   input,    width = 1,       src.ready
		.src_valid          (router_014_src_valid),                      //  output,    width = 1,          .valid
		.src_data           (router_014_src_data),                       //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_015 (
		.sink_ready         (wr_ddrvld_s1_agent_rp_ready),             //  output,    width = 1,      sink.ready
		.sink_valid         (wr_ddrvld_s1_agent_rp_valid),             //   input,    width = 1,          .valid
		.sink_data          (wr_ddrvld_s1_agent_rp_data),              //   input,  width = 104,          .data
		.sink_startofpacket (wr_ddrvld_s1_agent_rp_startofpacket),     //   input,    width = 1,          .startofpacket
		.sink_endofpacket   (wr_ddrvld_s1_agent_rp_endofpacket),       //   input,    width = 1,          .endofpacket
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready          (router_015_src_ready),                    //   input,    width = 1,       src.ready
		.src_valid          (router_015_src_valid),                    //  output,    width = 1,          .valid
		.src_data           (router_015_src_data),                     //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_016 (
		...
		.sink_data          (power_temp_scl_s1_agent_rp_data),                  //   input,  width = 104,          .data
		...
		.src_data           (router_016_src_data),                              //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_router_181_dc3dh7q router_017 (
		...
		.sink_data          (power_temp_sda_s1_agent_rp_data),                  //   input,  width = 104,          .data
		...
		.src_data           (router_017_src_data),                              //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_sink_channel       (router_src_channel),                              //   input,   width = 16,          .channel
		...
		.cmd_src_channel        (nios2_data_master_limiter_cmd_src_channel),       //  output,   width = 16,          .channel
		...
		.rsp_sink_channel       (rsp_mux_src_channel),                             //   input,   width = 16,          .channel
		...
		.rsp_src_channel        (nios2_data_master_limiter_rsp_src_channel),       //  output,   width = 16,          .channel
		...
		.cmd_src_valid          (nios2_data_master_limiter_cmd_valid_data)         //  output,   width = 16, cmd_valid.data
	);
	...
	nios_qsys_altera_merlin_traffic_limiter_181_reppfiq #(
		...
		.cmd_sink_channel       (router_001_src_channel),                                 //   input,   width = 16,          .channel
		...
		.cmd_src_channel        (nios2_instruction_master_limiter_cmd_src_channel),       //  output,   width = 16,          .channel
		...
		.rsp_sink_channel       (rsp_mux_001_src_channel),                                //   input,   width = 16,          .channel
		...
		.rsp_src_channel        (nios2_instruction_master_limiter_rsp_src_channel),       //  output,   width = 16,          .channel
		...
		.cmd_src_valid          (nios2_instruction_master_limiter_cmd_valid_data)         //  output,   width = 16, cmd_valid.data
	);

	nios_qsys_altera_merlin_demultiplexer_181_e5vcbgy cmd_demux (
		.clk                 (clock_in_out_clk_clk),                            //   input,    width = 1,        clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset),         //   input,    width = 1,  clk_reset.reset
		.sink_ready          (nios2_data_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel        (nios2_data_master_limiter_cmd_src_channel),       //   input,   width = 16,           .channel
		...
		.sink_valid          (nios2_data_master_limiter_cmd_valid_data),        //   input,   width = 16, sink_valid.data
		...
		.src1_channel        (cmd_demux_src1_channel),                          //  output,   width = 16,           .channel
		...
		.src2_channel        (cmd_demux_src2_channel),                          //  output,   width = 16,           .channel
		...
		.src3_channel        (cmd_demux_src3_channel),                          //  output,   width = 16,           .channel
		...
		.src4_channel        (cmd_demux_src4_channel),                          //  output,   width = 16,           .channel
		...
		.src5_channel        (cmd_demux_src5_channel),                          //  output,   width = 16,           .channel
		...
		.src6_channel        (cmd_demux_src6_channel),                          //  output,   width = 16,           .channel
		...
		.src7_channel        (cmd_demux_src7_channel),                          //  output,   width = 16,           .channel
		...
		.src8_channel        (cmd_demux_src8_channel),                          //  output,   width = 16,           .channel
		...
		.src9_channel        (cmd_demux_src9_channel),                          //  output,   width = 16,           .channel
		...
		.src10_channel       (cmd_demux_src10_channel),                         //  output,   width = 16,           .channel
		...
		.src11_data          (cmd_demux_src11_data),                            //  output,  width = 104,           .data
		.src11_channel       (cmd_demux_src11_channel),                         //  output,   width = 16,           .channel
		...
		.src12_data          (cmd_demux_src12_data),                            //  output,  width = 104,           .data
		.src12_channel       (cmd_demux_src12_channel),                         //  output,   width = 16,           .channel
		...
		.src13_data          (cmd_demux_src13_data),                            //  output,  width = 104,           .data
		.src13_channel       (cmd_demux_src13_channel),                         //  output,   width = 16,           .channel
		...
		.src14_data          (cmd_demux_src14_data),                            //  output,  width = 104,           .data
		.src14_channel       (cmd_demux_src14_channel),                         //  output,   width = 16,           .channel
		...
		.src15_data          (cmd_demux_src15_data),                            //  output,  width = 104,           .data
		.src15_channel       (cmd_demux_src15_channel),                         //  output,   width = 16,           .channel
	...
	nios_qsys_altera_merlin_demultiplexer_181_im7f3ba cmd_demux_001 (
		.clk                (clock_in_out_clk_clk),                                   //   input,    width = 1,        clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset),                //   input,    width = 1,  clk_reset.reset
		.sink_ready         (nios2_instruction_master_limiter_cmd_src_ready),         //  output,    width = 1,       sink.ready
		.sink_channel       (nios2_instruction_master_limiter_cmd_src_channel),       //   input,   width = 16,           .channel
		...
		.sink_valid         (nios2_instruction_master_limiter_cmd_valid_data),        //   input,   width = 16, sink_valid.data
		...
		.src1_channel       (cmd_demux_001_src1_channel),                             //  output,   width = 16,           .channel
		...
		.src2_channel       (cmd_demux_001_src2_channel),                             //  output,   width = 16,           .channel
		...
		.src3_channel       (cmd_demux_001_src3_channel),                             //  output,   width = 16,           .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_cvhx22i cmd_mux (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src0_channel),                  //   input,   width = 16,          .channel
		...
		.sink1_channel       (cmd_demux_001_src0_channel),              //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_cvhx22i cmd_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src1_channel),                  //   input,   width = 16,          .channel
		...
		.sink1_channel       (cmd_demux_001_src1_channel),              //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_cvhx22i cmd_mux_002 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src2_channel),                  //   input,   width = 16,          .channel
		...
		.sink1_channel       (cmd_demux_001_src2_channel),              //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_cvhx22i cmd_mux_003 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src3_channel),                  //   input,   width = 16,          .channel
		...
		.sink1_channel       (cmd_demux_001_src3_channel),              //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_004 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src4_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_005 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src5_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_006 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src6_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_007 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src7_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_008 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src8_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_009 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src9_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_010 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (cmd_demux_src10_channel),                 //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_011 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_011_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_011_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_011_src_data),                    //  output,  width = 104,          .data
		...
		.sink0_channel       (cmd_demux_src11_channel),                 //   input,   width = 16,          .channel
		.sink0_data          (cmd_demux_src11_data),                    //   input,  width = 104,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_012 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_012_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_012_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_012_src_data),                    //  output,  width = 104,          .data
		...
		.sink0_channel       (cmd_demux_src12_channel),                 //   input,   width = 16,          .channel
		.sink0_data          (cmd_demux_src12_data),                    //   input,  width = 104,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_013 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_013_src_ready),                   //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_013_src_valid),                   //  output,    width = 1,          .valid
		.src_data            (cmd_mux_013_src_data),                    //  output,  width = 104,          .data
		...
		.sink0_channel       (cmd_demux_src13_channel),                 //   input,   width = 16,          .channel
		.sink0_data          (cmd_demux_src13_data),                    //   input,  width = 104,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_014 (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (power_temp_scl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_014_src_ready),                            //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_014_src_valid),                            //  output,    width = 1,          .valid
		.src_data            (cmd_mux_014_src_data),                             //  output,  width = 104,          .data
		...
		.sink0_channel       (cmd_demux_src14_channel),                          //   input,   width = 16,          .channel
		.sink0_data          (cmd_demux_src14_data),                             //   input,  width = 104,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_icrfl4q cmd_mux_015 (
		.clk                 (clock_in_out_clk_clk),                             //   input,    width = 1,       clk.clk
		.reset               (power_temp_scl_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.src_ready           (cmd_mux_015_src_ready),                            //   input,    width = 1,       src.ready
		.src_valid           (cmd_mux_015_src_valid),                            //  output,    width = 1,          .valid
		.src_data            (cmd_mux_015_src_data),                             //  output,  width = 104,          .data
		...
		.sink0_channel       (cmd_demux_src15_channel),                          //   input,   width = 16,          .channel
		.sink0_data          (cmd_demux_src15_data),                             //   input,  width = 104,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_tvhk6li rsp_demux (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_tvhk6li rsp_demux_001 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_tvhk6li rsp_demux_002 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_004_src_ready),                    //  output,    width = 1,      sink.ready
		.sink_channel       (router_004_src_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_demultiplexer_181_tvhk6li rsp_demux_003 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		.sink_ready         (router_005_src_ready),                    //  output,    width = 1,      sink.ready
		.sink_channel       (router_005_src_channel),                  //   input,   width = 16,          .channel
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_004 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_005 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_006 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_007 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_008 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_009 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_010 (
		.clk                (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset              (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_011 (
		...
		.src0_data          (rsp_demux_011_src0_data),                 //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_012 (
		...
		.src0_data          (rsp_demux_012_src0_data),                 //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_013 (
		...
		.src0_data          (rsp_demux_013_src0_data),                 //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_014 (
		...
		.src0_data          (rsp_demux_014_src0_data),                          //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_demultiplexer_181_my7swpq rsp_demux_015 (
		...
		.src0_data          (rsp_demux_015_src0_data),                          //  output,  width = 104,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_5nu35kq rsp_mux (
		.clk                  (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset                (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel        (rsp_demux_src0_channel),                  //   input,   width = 16,          .channel
		...
		.sink1_channel        (rsp_demux_001_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink2_channel        (rsp_demux_002_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink3_channel        (rsp_demux_003_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink4_channel        (rsp_demux_004_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink5_channel        (rsp_demux_005_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink6_channel        (rsp_demux_006_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink7_channel        (rsp_demux_007_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink8_channel        (rsp_demux_008_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink9_channel        (rsp_demux_009_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink10_channel       (rsp_demux_010_src0_channel),              //   input,   width = 16,          .channel
		...
		.sink11_channel       (rsp_demux_011_src0_channel),              //   input,   width = 16,          .channel
		.sink11_data          (rsp_demux_011_src0_data),                 //   input,  width = 104,          .data
		...
		.sink12_channel       (rsp_demux_012_src0_channel),              //   input,   width = 16,          .channel
		.sink12_data          (rsp_demux_012_src0_data),                 //   input,  width = 104,          .data
		...
		.sink13_channel       (rsp_demux_013_src0_channel),              //   input,   width = 16,          .channel
		.sink13_data          (rsp_demux_013_src0_data),                 //   input,  width = 104,          .data
		...
		.sink14_channel       (rsp_demux_014_src0_channel),              //   input,   width = 16,          .channel
		.sink14_data          (rsp_demux_014_src0_data),                 //   input,  width = 104,          .data
		...
		.sink15_channel       (rsp_demux_015_src0_channel),              //   input,   width = 16,          .channel
		.sink15_data          (rsp_demux_015_src0_data),                 //   input,  width = 104,          .data
	...
	nios_qsys_altera_merlin_multiplexer_181_trn5aga rsp_mux_001 (
		.clk                 (clock_in_out_clk_clk),                    //   input,    width = 1,       clk.clk
		.reset               (nios2_reset_reset_bridge_in_reset_reset), //   input,    width = 1, clk_reset.reset
		...
		.sink0_channel       (rsp_demux_src1_channel),                  //   input,   width = 16,          .channel
		...
		.sink1_channel       (rsp_demux_001_src1_channel),              //   input,   width = 16,          .channel
