...
# ACDS 18.1 222 linux 2020.08.23.02:39:21
...
# delete the xxx:: -- like
# set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [xxx::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
...
if [ $SKIP_ELAB -eq 0 ]; then
  #vcs -lca -debug_access -t ps -liblist_work $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS $TOP_LEVEL_NAME -P /software/synopsys/verdi-2016/share/PLI/VCS/LINUX64/novas.tab /software/synopsys/verdi-2016/share/PLI/VCS/LINUX64/pli.a

  vcs -lca -debug_access -t ps -liblist_work $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS $TOP_LEVEL_NAME -l vcs.log
